...
class MockServerRequestHandler_v1_3_1(BaseHTTPRequestHandler):
    ...
    NON_FABRIC_WIRELESS_098cab9141c9a3fe_PATTERN = re.compile(r"/dna/intent/api/v1/wireless/rf-profile")
    NON_FABRIC_WIRELESS_1eb72ad34e098990_PATTERN = re.compile(r"/dna/intent/api/v1/business/ssid")
    NON_FABRIC_WIRELESS_28b24a744a9994be_PATTERN = re.compile(r"/dna/intent/api/v1/wireless/rf-profile/string")
    NON_FABRIC_WIRELESS_b3a1c8804c8b9b8b_PATTERN = re.compile(r"/dna/intent/api/v1/wireless/profile")
    NON_FABRIC_WIRELESS_cfbd3870405aad55_PATTERN = re.compile(r"/dna/intent/api/v1/wireless/profile")
    NON_FABRIC_WIRELESS_fc9538fe43d9884d_PATTERN = re.compile(r"/dna/intent/api/v1/business/ssid/string/string")
    NON_FABRIC_WIRELESS_709769624bf988d5_PATTERN = re.compile(r"/dna/intent/api/v1/wireless/profile")
    NON_FABRIC_WIRELESS_8a96fb954d09a349_PATTERN = re.compile(r"/dna/intent/api/v1/enterprise-ssid")
    NON_FABRIC_WIRELESS_e39588a5494982c4_PATTERN = re.compile(r"/dna/intent/api/v1/wireless-profile/string")
    NON_FABRIC_WIRELESS_87a5ab044139862d_PATTERN = re.compile(r"/dna/intent/api/v1/wireless/provision")
    NON_FABRIC_WIRELESS_b78329674878b815_PATTERN = re.compile(r"/dna/intent/api/v1/wireless/rf-profile")
    NON_FABRIC_WIRELESS_d09b08a3447aa3b9_PATTERN = re.compile(r"/dna/intent/api/v1/wireless/provision")
    ...
    NON_FABRIC_WIRELESS_e9b99b2248c88014_PATTERN = re.compile(r"/dna/intent/api/v1/wireless/ap-provision")
    FABRIC_WIRED_549e4aff42bbb52a_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/virtualnetwork/ippool")
    FABRIC_WIRED_1fb8f9f24c998133_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/edge-device")
    FABRIC_WIRED_3ebcda3e4acbafb7_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/authentication-profile")
    FABRIC_WIRED_8984ea7744d98a54_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/authentication-profile")
    FABRIC_WIRED_7683f90b4efab090_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/edge-device")
    FABRIC_WIRED_9582ab824ce8b29d_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/hostonboarding/user-device")
    FABRIC_WIRED_cb81b93540baaab0_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/border-device")
    FABRIC_WIRED_87a8ba444ce9bc59_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/edge-device")
    FABRIC_WIRED_bca339d844c8a3c0_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/authentication-profile")
    FABRIC_WIRED_cba5b8b14edb81f4_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/hostonboarding/user-device")
    FABRIC_WIRED_208579ea4ed98f4f_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/virtualnetwork/ippool")
    FABRIC_WIRED_98a39bf4485a9871_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/border-device")
    FABRIC_WIRED_a4a1e8ed41cb9653_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/hostonboarding/user-device")
    FABRIC_WIRED_8b908a4e4c5a9a23_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/authentication-profile")
    FABRIC_WIRED_bead7b3443b996a7_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/border-device")
    FABRIC_WIRED_fa9219bf45c8b43b_PATTERN = re.compile(r"/dna/intent/api/v1/business/sda/virtualnetwork/ippool")
    ...
    def sites_get_site_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'status': 'string', 'response': [{'parentId': 'string', 'systemGroup': 'string', 'name': 'string', 'groupTypeList': ['string'], 'additionalInfo': ['string'], 'groupHierarchy': 'string', 'groupNameHierarchy': 'string', 'instanceTenantId': 'string', 'id': 'string'}]})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def matches_NON_FABRIC_WIRELESS_098cab9141c9a3fe(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_098cab9141c9a3fe_PATTERN,
            self.path
        )

    def non_fabric_wireless_retrieve_r_fprofiles_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NON_FABRIC_WIRELESS_1eb72ad34e098990(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_1eb72ad34e098990_PATTERN,
            self.path
        )
    ...
    def matches_NON_FABRIC_WIRELESS_28b24a744a9994be(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_28b24a744a9994be_PATTERN,
            self.path
        )

    def non_fabric_wireless_delete_r_fprofiles_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NON_FABRIC_WIRELESS_b3a1c8804c8b9b8b(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_b3a1c8804c8b9b8b_PATTERN,
            self.path
        )
    ...
    def matches_NON_FABRIC_WIRELESS_cfbd3870405aad55(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_cfbd3870405aad55_PATTERN,
            self.path
        )
    ...
    def matches_NON_FABRIC_WIRELESS_fc9538fe43d9884d(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_fc9538fe43d9884d_PATTERN,
            self.path
        )

    def non_fabric_wireless_delete_ssidandprovisionittodevices_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NON_FABRIC_WIRELESS_709769624bf988d5(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_709769624bf988d5_PATTERN,
            self.path
        )
    ...
    def matches_NON_FABRIC_WIRELESS_e39588a5494982c4(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_e39588a5494982c4_PATTERN,
            self.path
        )
    ...
    def matches_NON_FABRIC_WIRELESS_87a5ab044139862d(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_87a5ab044139862d_PATTERN,
            self.path
        )

    def non_fabric_wireless_provisionupdate_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NON_FABRIC_WIRELESS_b78329674878b815(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_b78329674878b815_PATTERN,
            self.path
        )

    def non_fabric_wireless_createor_update_r_fprofile_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_NON_FABRIC_WIRELESS_d09b08a3447aa3b9(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_d09b08a3447aa3b9_PATTERN,
            self.path
        )
    ...
    def matches_NON_FABRIC_WIRELESS_e9b99b2248c88014(self):
        return re.search(
            self.NON_FABRIC_WIRELESS_e9b99b2248c88014_PATTERN,
            self.path
        )

    def non_fabric_wireless_ap_provision_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_549e4aff42bbb52a(self):
        return re.search(
            self.FABRIC_WIRED_549e4aff42bbb52a_PATTERN,
            self.path
        )

    def fabric_wired_delete_ip_poolfrom_sda_virtual_network_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_1fb8f9f24c998133(self):
        return re.search(
            self.FABRIC_WIRED_1fb8f9f24c998133_PATTERN,
            self.path
        )

    def fabric_wired_deleteedgedevice_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_3ebcda3e4acbafb7(self):
        return re.search(
            self.FABRIC_WIRED_3ebcda3e4acbafb7_PATTERN,
            self.path
        )

    def fabric_wired_deletedefaultauthenticationprofile_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_8984ea7744d98a54(self):
        return re.search(
            self.FABRIC_WIRED_8984ea7744d98a54_PATTERN,
            self.path
        )

    def fabric_wired_updatedefaultauthenticationprofile_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_7683f90b4efab090(self):
        return re.search(
            self.FABRIC_WIRED_7683f90b4efab090_PATTERN,
            self.path
        )

    def fabric_wired_getedgedevice_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_9582ab824ce8b29d(self):
        return re.search(
            self.FABRIC_WIRED_9582ab824ce8b29d_PATTERN,
            self.path
        )

    def fabric_wired_add_portassignmentforuserdevice_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def fabric_wired_deletesborderdevice_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_87a8ba444ce9bc59(self):
        return re.search(
            self.FABRIC_WIRED_87a8ba444ce9bc59_PATTERN,
            self.path
        )

    def fabric_wired_addedgedevice_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_bca339d844c8a3c0(self):
        return re.search(
            self.FABRIC_WIRED_bca339d844c8a3c0_PATTERN,
            self.path
        )

    def fabric_wired_adddefaultauthenticationprofile_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_cba5b8b14edb81f4(self):
        return re.search(
            self.FABRIC_WIRED_cba5b8b14edb81f4_PATTERN,
            self.path
        )

    def fabric_wired_delete_portassignmentforuserdevice_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_208579ea4ed98f4f(self):
        return re.search(
            self.FABRIC_WIRED_208579ea4ed98f4f_PATTERN,
            self.path
        )

    def fabric_wired_add_ip_poolin_sda_virtual_network_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def fabric_wired_getsborderdevicedetail_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_a4a1e8ed41cb9653(self):
        return re.search(
            self.FABRIC_WIRED_a4a1e8ed41cb9653_PATTERN,
            self.path
        )

    def fabric_wired_get_portassignmentforuserdevice_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_8b908a4e4c5a9a23(self):
        return re.search(
            self.FABRIC_WIRED_8b908a4e4c5a9a23_PATTERN,
            self.path
        )

    def fabric_wired_getdefaultauthenticationprofile_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def fabric_wired_addsborderdevice_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_FABRIC_WIRED_fa9219bf45c8b43b(self):
        return re.search(
            self.FABRIC_WIRED_fa9219bf45c8b43b_PATTERN,
            self.path
        )

    def fabric_wired_get_ip_poolfrom_sda_virtual_network_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def do_GET(self):
        ...
        if self.matches_NON_FABRIC_WIRELESS_098cab9141c9a3fe():
            self.non_fabric_wireless_retrieve_r_fprofiles_response()
            return

        if self.matches_NON_FABRIC_WIRELESS_b3a1c8804c8b9b8b():
        ...
        if self.matches_FABRIC_WIRED_7683f90b4efab090():
            self.fabric_wired_getedgedevice_response()
            return
        ...
        if self.matches_FABRIC_WIRED_a4a1e8ed41cb9653():
            self.fabric_wired_get_portassignmentforuserdevice_response()
            return

        if self.matches_FABRIC_WIRED_8b908a4e4c5a9a23():
            self.fabric_wired_getdefaultauthenticationprofile_response()
            return

        if self.matches_FABRIC_WIRED_fa9219bf45c8b43b():
            self.fabric_wired_get_ip_poolfrom_sda_virtual_network_response()
            return
    ...
    def do_POST(self):
        ...
        if self.matches_NON_FABRIC_WIRELESS_1eb72ad34e098990():
            self.non_fabric_wireless_createand_provision_ssid_response()
            return

        if self.matches_NON_FABRIC_WIRELESS_709769624bf988d5():
        ...
        if self.matches_NON_FABRIC_WIRELESS_b78329674878b815():
            self.non_fabric_wireless_createor_update_r_fprofile_response()
            return

        if self.matches_NON_FABRIC_WIRELESS_d09b08a3447aa3b9():
            self.non_fabric_wireless_provision_response()
            return

        if self.matches_NON_FABRIC_WIRELESS_e9b99b2248c88014():
            self.non_fabric_wireless_ap_provision_response()
            return

        if self.matches_FABRIC_WIRED_9582ab824ce8b29d():
            self.fabric_wired_add_portassignmentforuserdevice_response()
            return

        if self.matches_FABRIC_WIRED_87a8ba444ce9bc59():
            self.fabric_wired_addedgedevice_response()
            return

        if self.matches_FABRIC_WIRED_bca339d844c8a3c0():
            self.fabric_wired_adddefaultauthenticationprofile_response()
            return

        if self.matches_FABRIC_WIRED_208579ea4ed98f4f():
            self.fabric_wired_add_ip_poolin_sda_virtual_network_response()
            return

        if self.matches_FABRIC_WIRED_bead7b3443b996a7():
            self.fabric_wired_addsborderdevice_response()
            return
    ...
    def do_PUT(self):
        ...
        if self.matches_NON_FABRIC_WIRELESS_cfbd3870405aad55():
            self.non_fabric_wireless_update_wireless_profile_response()
            return

        if self.matches_NON_FABRIC_WIRELESS_87a5ab044139862d():
            self.non_fabric_wireless_provisionupdate_response()
            return

        if self.matches_FABRIC_WIRED_8984ea7744d98a54():
            self.fabric_wired_updatedefaultauthenticationprofile_response()
            return
    ...
    def do_DELETE(self):
        ...
        if self.matches_NON_FABRIC_WIRELESS_28b24a744a9994be():
            self.non_fabric_wireless_delete_r_fprofiles_response()
            return

        if self.matches_NON_FABRIC_WIRELESS_fc9538fe43d9884d():
            self.non_fabric_wireless_delete_ssidandprovisionittodevices_response()
            return

        if self.matches_NON_FABRIC_WIRELESS_e39588a5494982c4():
        ...
        if self.matches_FABRIC_WIRED_549e4aff42bbb52a():
            self.fabric_wired_delete_ip_poolfrom_sda_virtual_network_response()
            return

        if self.matches_FABRIC_WIRED_1fb8f9f24c998133():
            self.fabric_wired_deleteedgedevice_response()
            return

        if self.matches_FABRIC_WIRED_3ebcda3e4acbafb7():
            self.fabric_wired_deletedefaultauthenticationprofile_response()
            return

        if self.matches_FABRIC_WIRED_cb81b93540baaab0():
            self.fabric_wired_deletesborderdevice_response()
            return

        if self.matches_FABRIC_WIRED_cba5b8b14edb81f4():
            self.fabric_wired_delete_portassignmentforuserdevice_response()
            return
