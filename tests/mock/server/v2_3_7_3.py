...
class MockServerRequestHandler_v2_3_7_3(BaseHTTPRequestHandler):
    ...
    SDA_c7805197a1cc51109089b1ad23e5078a_PATTERN = re.compile(r"/dna/intent/api/v1/sda/fabricSites")
    ...
    SDA_71200305372b5bb0ab2b0e55f4ee405e_PATTERN = re.compile(r"/dna/intent/api/v1/sda/fabricZones")
    ...
    def application_policy_get_applications2_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'id': 'string', 'name': 'string', 'indicativeNetworkIdentity': [{'id': 'string', 'displayName': 'string', 'lowerPort': 0, 'ports': 'string', 'protocol': 'string', 'upperPort': 0}], 'networkApplications': [{'id': 'string', 'appProtocol': 'string', 'applicationSubType': 'string', 'applicationType': 'string', 'categoryId': 'string', 'displayName': 'string', 'engineId': 'string', 'helpString': 'string', 'longDescription': 'string', 'name': 'string', 'popularity': 'string', 'rank': 'string', 'trafficClass': 'string', 'serverName': 'string', 'url': 'string', 'dscp': 'string', 'ignoreConflict': 'string'}], 'networkIdentity': [{'id': 'string', 'displayName': 'string', 'lowerPort': 'string', 'ports': 'string', 'protocol': 'string', 'upperPort': 'string'}], 'applicationSet': {'idRef': 'string'}}]})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def configuration_archive_get_configuration_archive_details_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'archiveResultlist': [{'ipAddress': 'string', 'deviceId': 'string', 'versions': [{'files': [{'fileType': 'string', 'fileId': 'string', 'downloadPath': 'string', 'name': 'string'}], 'configChangeType': 'string', 'syslogConfigEventDto': {'userName': 'string', 'deviceUuid': 'string', 'outOfBand': True, 'configMethod': 'string', 'terminalName': 'string', 'loginIpAddress': 'string', 'processName': 'string', 'syslogTime': 'string'}, 'createdBy': 'string', 'createdTime': 0, 'startupRunningStatus': 'string', 'id': 'string'}], 'deviceName': 'string'}]})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def devices_get_interface_details_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'adminStatus': 'string', 'className': 'string', 'description': 'string', 'deviceId': 'string', 'duplex': 'string', 'id': 'string', 'ifIndex': 'string', 'instanceTenantId': 'string', 'instanceUuid': 'string', 'interfaceType': 'string', 'ipv4Address': 'string', 'ipv4Mask': 'string', 'isisSupport': 'string', 'lastUpdated': 'string', 'macAddress': 'string', 'mappedPhysicalInterfaceId': 'string', 'mappedPhysicalInterfaceName': 'string', 'mediaType': 'string', 'nativeVlanId': 'string', 'ospfSupport': 'string', 'pid': 'string', 'portMode': 'string', 'portName': 'string', 'portType': 'string', 'serialNo': 'string', 'series': 'string', 'speed': 'string', 'status': 'string', 'vlanId': 'string', 'voiceVlan': 'string', 'poweroverethernet': 'string', 'networkdevice_id': 'string', 'mtu': 'string', 'addresses': 'string', 'name': 'string', 'lastInput': 'string', 'managedComputeElement': 'string', 'lastOutput': 'string', 'managedNetworkElement': 'string', 'managedNetworkElementUrl': 'string', 'managedComputeElementUrl': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_get_vn_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'siteNameHierarchy': 'string', 'virtualNetworkName': 'string', 'fabricName': 'string', 'isInfraVN': 'string', 'isDefaultVN': 'string', 'virtualNetworkContextId': 'string', 'virtualNetworkId': 'string', 'status': 'string', 'description': 'string', 'executionId': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_get_authentication_profiles_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'id': 'string', 'siteNameHierarchy': 'string', 'authenticationProfileName': 'string', 'authenticationOrder': 'string', 'dot1xToMabFallbackTimeout': 0, 'wakeOnLan': True, 'numberOfHosts': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_update_extranet_policy_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': {'id': 'string', 'url': 'string'}, 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_get_extranet_policy_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'id': 'string', 'extranetPolicyName': 'string', 'siteNameHierarchies': ['string'], 'providerVirtualNetworkName': 'string', 'subscriberVirtualNetworkNames': ['string'], 'sharedSdaTransitNames': ['string']}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_get_fabric_sites_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'id': 'string', 'siteNameHierarchy': 'string', 'authenticationProfileName': 'string', 'isPubSubEnabled': True}])
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def matches_SDA_c7805197a1cc51109089b1ad23e5078a(self):
        return re.search(
            self.SDA_c7805197a1cc51109089b1ad23e5078a_PATTERN,
            self.path
        )

    def sda_delete_fabric_site_by_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def sda_get_fabric_zones_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'id': 'string', 'siteNameHierarchy': 'string', 'authenticationProfileName': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def matches_SDA_71200305372b5bb0ab2b0e55f4ee405e(self):
        return re.search(
            self.SDA_71200305372b5bb0ab2b0e55f4ee405e_PATTERN,
            self.path
        )

    def sda_delete_fabric_zone_by_name_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def wireless_configure_access_points2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def do_GET(self):
        ...
        if self.matches_SDA_c88d4f7170b9553abf9af4d011a25f0f():
            self.sda_get_extranet_policy_response()
            return
    ...
    def do_POST(self):
        ...
        if self.matches_WIRELESS_6e0bd567c1395531a7f18ab4e14110bd():
            self.wireless_configure_access_points2_response()
            return
    ...
    def do_DELETE(self):
        ...
        if self.matches_SDA_c7805197a1cc51109089b1ad23e5078a():
            self.sda_delete_fabric_site_by_name_response()
            return
        ...
        if self.matches_SDA_71200305372b5bb0ab2b0e55f4ee405e():
            self.sda_delete_fabric_zone_by_name_response()
            return
