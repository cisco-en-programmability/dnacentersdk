...
class MockServerRequestHandler_v2_2_3_3(BaseHTTPRequestHandler):
    ...
    def event_management_get_event_subscriptions_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'subscriptionId': 'string', 'isPrivate': True, 'tenantId': 'string', 'version': 'string', 'name': 'string', 'description': 'string', 'subscriptionEndpoints': [{'instanceId': 'string', 'id': 'string', 'subscriptionDetails': {'name': 'string', 'url': 'string', 'method': 'string', 'connectorType': 'string'}}], 'filter': {'eventIds': ['string']}}])
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_get_multicast_details_from_sda_fabric_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'siteNameHierarchy': 'string', 'multicastMethod': 'string', 'muticastType': 'string', 'multicastVnInfo': {'virtualNetworkName': 'string', 'ipPoolName': 'string', 'externalRpIpAddress': 'string', 'ssmInfo': {}, 'ssmGroupRange': 'string', 'ssmWildcardMask': 'string'}})
        self.wfile.write(response_content.encode('utf-8'))
        return
