...
class MockServerRequestHandler_v2_3_2_0(BaseHTTPRequestHandler):
    ...
    EVENT_MANAGEMENT_814fa2dae350583e82ff05c1e255fabb_PATTERN = re.compile(r"/dna/intent/api/v1/event/syslogConfig")
    EVENT_MANAGEMENT_90481a5a2445541ca85b4cd853de7524_PATTERN = re.compile(r"/dna/intent/api/v1/event/syslogConfig")
    ...
    POLICY_2194bf80823752baba63a8849fd521cd_PATTERN = re.compile(r"/dna/intent/api/v1/endpoint-analytics/profiling-rules")
    POLICY_a4571194a9e05664ad348f72d7651bb0_PATTERN = re.compile(r"/dna/intent/api/v1/endpoint-analytics/profiling-rules")
    POLICY_90347931b4155d6f885a53ad0e47b1a4_PATTERN = re.compile(r"/dna/intent/api/v1/endpoint-analytics/profiling-rules/bulk")
    POLICY_2ec43ed2e44c5f3ea7a904d39af66899_PATTERN = re.compile(r"/dna/intent/api/v1/endpoint-analytics/profiling-rules/count")
    POLICY_1508a4dab79d54829548004029a91ba1_PATTERN = re.compile(r"/dna/intent/api/v1/endpoint-analytics/profiling-rules/string")
    POLICY_fbea90831e6e57e79062edab0c76f8a1_PATTERN = re.compile(r"/dna/intent/api/v1/endpoint-analytics/profiling-rules/string")
    POLICY_3a3f7b6780725e83beed53d6ce2256e4_PATTERN = re.compile(r"/dna/intent/api/v1/endpoint-analytics/profiling-rules/string")
    ...
    def matches_EVENT_MANAGEMENT_814fa2dae350583e82ff05c1e255fabb(self):
        return re.search(
            self.EVENT_MANAGEMENT_814fa2dae350583e82ff05c1e255fabb_PATTERN,
            self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_90481a5a2445541ca85b4cd853de7524(self):
        return re.search(
            self.EVENT_MANAGEMENT_90481a5a2445541ca85b4cd853de7524_PATTERN,
            self.path
        )
    ...
    def event_management_get_connector_types_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'connectorType': 'string', 'displayName': 'string', 'isDefaultSupported': 'string', 'isCustomConnector': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def lan_automation_lan_automation_status_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'id': 'string', 'discoveredDeviceSiteNameHierarchy': 'string', 'primaryDeviceManagmentIPAddress': 'string', 'ipPoolList': [{'ipPoolName': 'string', 'ipPoolRole': 'string'}], 'primaryDeviceInterfaceNames': ['string'], 'status': 'string', 'action': 'string', 'creationTime': 'string', 'multicastEnabled': True, 'peerDeviceManagmentIPAddress': 'string', 'discoveredDeviceList': [{'name': 'string', 'serialNumber': 'string', 'state': 'string', 'ipAddressInUseList': ['string']}]}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def matches_POLICY_2194bf80823752baba63a8849fd521cd(self):
        return re.search(
            self.POLICY_2194bf80823752baba63a8849fd521cd_PATTERN,
            self.path
        )

    def policy_create_a_profiling_rule_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_POLICY_a4571194a9e05664ad348f72d7651bb0(self):
        return re.search(
            self.POLICY_a4571194a9e05664ad348f72d7651bb0_PATTERN,
            self.path
        )

    def policy_get_list_of_profiling_rules_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_POLICY_90347931b4155d6f885a53ad0e47b1a4(self):
        return re.search(
            self.POLICY_90347931b4155d6f885a53ad0e47b1a4_PATTERN,
            self.path
        )

    def policy_import_profiling_rules_in_bulk_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_POLICY_2ec43ed2e44c5f3ea7a904d39af66899(self):
        return re.search(
            self.POLICY_2ec43ed2e44c5f3ea7a904d39af66899_PATTERN,
            self.path
        )

    def policy_get_count_of_profiling_rules_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_POLICY_1508a4dab79d54829548004029a91ba1(self):
        return re.search(
            self.POLICY_1508a4dab79d54829548004029a91ba1_PATTERN,
            self.path
        )

    def policy_update_an_existing_profiling_rule_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_POLICY_fbea90831e6e57e79062edab0c76f8a1(self):
        return re.search(
            self.POLICY_fbea90831e6e57e79062edab0c76f8a1_PATTERN,
            self.path
        )

    def policy_get_details_of_a_single_profiling_rule_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def matches_POLICY_3a3f7b6780725e83beed53d6ce2256e4(self):
        return re.search(
            self.POLICY_3a3f7b6780725e83beed53d6ce2256e4_PATTERN,
            self.path
        )

    def policy_delete_an_existing_profiling_rule_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def sda_get_multicast_details_from_sda_fabric_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'siteNameHierarchy': 'string', 'multicastMethod': 'string', 'multicastType': 'string', 'multicastVnInfo': [{'virtualNetworkName': 'string', 'ipPoolName': 'string', 'externalRpIpAddress': 'string', 'ssmInfo': [{'ssmGroupRange': 'string', 'ssmWildcardMask': 'string'}]}]})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def task_get_business_api_execution_details_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'bapiKey': 'string', 'bapiName': 'string', 'bapiExecutionId': 'string', 'startTime': 'string', 'startTimeEpoch': 0, 'endTime': 'string', 'endTimeEpoch': 0, 'timeDuration': 0, 'status': 'string', 'runtimeInstanceId': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def do_GET(self):
        ...
        if self.matches_POLICY_a4571194a9e05664ad348f72d7651bb0():
            self.policy_get_list_of_profiling_rules_response()
            return

        if self.matches_POLICY_2ec43ed2e44c5f3ea7a904d39af66899():
            self.policy_get_count_of_profiling_rules_response()
            return

        if self.matches_POLICY_fbea90831e6e57e79062edab0c76f8a1():
            self.policy_get_details_of_a_single_profiling_rule_response()
            return
    ...
    def do_POST(self):
        ...
        if self.matches_EVENT_MANAGEMENT_90481a5a2445541ca85b4cd853de7524():
        ...
        if self.matches_POLICY_2194bf80823752baba63a8849fd521cd():
            self.policy_create_a_profiling_rule_response()
            return

        if self.matches_POLICY_90347931b4155d6f885a53ad0e47b1a4():
            self.policy_import_profiling_rules_in_bulk_response()
            return
    ...
    def do_PUT(self):
        ...
        if self.matches_EVENT_MANAGEMENT_814fa2dae350583e82ff05c1e255fabb():
        ...
        if self.matches_POLICY_1508a4dab79d54829548004029a91ba1():
            self.policy_update_an_existing_profiling_rule_response()
            return
    ...
    def do_DELETE(self):
        ...
        if self.matches_POLICY_3a3f7b6780725e83beed53d6ce2256e4():
            self.policy_delete_an_existing_profiling_rule_response()
            return
