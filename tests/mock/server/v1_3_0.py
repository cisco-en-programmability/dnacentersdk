...
class MockServerRequestHandler_v1_3_0(BaseHTTPRequestHandler):
    ...
    def fabric_wired_adds_border_device_in_sda_fabric_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def fabric_wired_deletes_border_device_from_sda_fabric_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def fabric_wired_gets_border_device_details_from_sda_fabric_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def do_GET(self):
        ...
        if self.matches_FABRIC_WIRED_d0b3593c4a7aaf22():
            self.fabric_wired_gets_border_device_details_from_sda_fabric_response()
            return
    ...
    def do_POST(self):
        ...
        if self.matches_FABRIC_WIRED_a4b56a5f478a97dd():
            self.fabric_wired_adds_border_device_in_sda_fabric_response()
            return
    ...
    def do_DELETE(self):
        ...
        if self.matches_FABRIC_WIRED_1e80bb50430b8634():
            self.fabric_wired_deletes_border_device_from_sda_fabric_response()
            return
