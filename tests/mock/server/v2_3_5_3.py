...
class MockServerRequestHandler_v2_3_5_3(BaseHTTPRequestHandler):
    ...
    CISCO_DNA_CENTER_SYSTEM_5627d9227adc5f02b7cd264af7255d19_PATTERN = re.compile(r"/api/v1/onboarding/pnp-device/authorize")
    ...
    EVENT_MANAGEMENT_6e698d5a990a55158003a9f3250316a8_PATTERN = re.compile(r"/dna/intent/api/v1/event/snmp-config")
    ...
    def eo_x_get_eo_x_status_for_all_devices_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'deviceId': 'string', 'alertCount': 0, 'summary': [{'eoxType': 'string'}], 'scanStatus': 'string', 'lastScanTime': 0}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def event_management_get_email_destination_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'emailConfigId': 'string', 'primarySMTPConfig': {'hostName': 'string', 'port': 'string', 'userName': 'string', 'password': 'string', 'security': 'string'}, 'secondarySMTPConfig': {'hostName': 'string', 'port': 'string', 'userName': 'string', 'password': 'string', 'security': 'string'}, 'fromEmail': 'string', 'toEmail': 'string', 'subject': 'string', 'version': 'string', 'tenantId': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def matches_EVENT_MANAGEMENT_6e698d5a990a55158003a9f3250316a8(self):
        return re.search(
            self.EVENT_MANAGEMENT_6e698d5a990a55158003a9f3250316a8_PATTERN,
            self.path
        )
    ...
    def event_management_get_snmp_destination_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'errorMessage': {'errors': ['string']}, 'apiStatus': 'string', 'statusMessage': [{'version': 'string', 'tenantId': 'string', 'configId': 'string', 'name': 'string', 'description': 'string', 'ipAddress': 'string', 'port': 0, 'snmpVersion': 'string', 'community': 'string', 'userName': 'string', 'snmpMode': 'string', 'snmpAuthType': 'string', 'authPassword': 'string', 'snmpPrivacyType': 'string', 'privacyPassword': 'string'}]})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def event_management_get_webhook_destination_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'errorMessage': {'errors': ['string']}, 'apiStatus': 'string', 'statusMessage': [{'version': 'string', 'tenantId': 'string', 'webhookId': 'string', 'name': 'string', 'description': 'string', 'url': 'string', 'method': 'string', 'trustCert': True, 'headers': [{'name': 'string', 'value': 'string', 'defaultValue': 'string', 'encrypt': True}]}]})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def lan_automation_lan_automation_status_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'id': 'string', 'discoveredDeviceSiteNameHierarchy': 'string', 'primaryDeviceManagmentIPAddress': 'string', 'ipPoolList': [{'ipPoolName': 'string', 'ipPoolRole': 'string'}], 'primaryDeviceInterfaceNames': ['string'], 'status': 'string', 'action': 'string', 'creationTime': 'string', 'multicastEnabled': True, 'peerDeviceManagmentIPAddress': 'string', 'discoveredDeviceList': [{'name': 'string', 'serialNumber': 'string', 'state': 'string', 'ipAddressInUseList': ['string']}], 'redistributeIsisToBgp': True}], 'version': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def network_settings_get_service_provider_details_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'response': [{'instanceType': 'string', 'instanceUuid': 'string', 'namespace': 'string', 'type': 'string', 'key': 'string', 'version': 'string', 'value': [{'wanProvider': 'string', 'spProfileName': 'string', 'slaProfileName': 'string'}], 'groupUuid': 'string', 'inheritedGroupUuid': 'string', 'inheritedGroupName': 'string'}], 'version': 0})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_get_default_authentication_profile_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps([{'siteNameHierarchy': 'string', 'authenticateTemplateName': 'string', 'authenticationOrder': 'string', 'dot1xToMabFallbackTimeout': 'string', 'wakeOnLan': True, 'numberOfHosts': 'string', 'status': 'string', 'description': 'string'}])
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_get_vn_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'siteNameHierarchy': 'string', 'virtualNetworkName': 'string', 'fabricName': 'string', 'isInfraVN': 'string', 'isDefaultVN': 'string', 'status': 'string', 'description': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_get_virtual_network_summary_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'virtualNetworkCount': 0, 'virtualNetworkSummary': [{'siteNameHierarchy': 'string', 'virtualNetworkName': 'string'}], 'status': 'string', 'description': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_get_virtual_network_with_scalable_groups_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'virtualNetworkName': 'string', 'isGuestVirtualNetwork': True, 'scalableGroupNames': ['string'], 'vManageVpnId': 'string', 'status': 'string', 'description': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def task_get_business_api_execution_details_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'bapiKey': 'string', 'bapiName': 'string', 'bapiExecutionId': 'string', 'startTime': 'string', 'startTimeEpoch': 0, 'endTime': 'string', 'endTimeEpoch': 0, 'timeDuration': 0, 'status': 'string', 'bapiError': 'string', 'runtimeInstanceId': 'string'})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def user_and_roles_get_permissions_ap_i_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def user_and_roles_get_roles_ap_i_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def user_and_roles_get_users_ap_i_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def user_and_roles_add_user_ap_i_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def user_and_roles_update_user_ap_i_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def user_and_roles_get_external_authentication_servers_ap_i_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def do_GET(self):
        ...
        if self.matches_user_and_roles_9ec0b30eca9d540a845848cffd7c602a():
            self.user_and_roles_get_permissions_ap_i_response()
            return

        if self.matches_user_and_roles_bef02e8f6f8354dc99e375826a87c88c():
            self.user_and_roles_get_roles_ap_i_response()
            return

        if self.matches_user_and_roles_7fa405b6d1be56739f2dfeea63212015():
            self.user_and_roles_get_users_ap_i_response()
            return

        if self.matches_user_and_roles_452738def9045d4d9c96bcd42172a79c():
            self.user_and_roles_get_external_authentication_servers_ap_i_response()
            return
    ...
    def do_POST(self):
        ...
        if self.matches_user_and_roles_6d82755e5e03510daf0951c1f42c2702():
            self.user_and_roles_add_user_ap_i_response()
            return
    ...
    def do_PUT(self):
        ...
        if self.matches_user_and_roles_34d2bd5f05bd535a89ebadb30e2ede9e():
            self.user_and_roles_update_user_ap_i_response()
            return
