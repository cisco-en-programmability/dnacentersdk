...
class MockServerRequestHandler_v2_3_5_3(BaseHTTPRequestHandler):
    AUTHENTICATION_ac8ae94c4e69a09d_PATTERN = re.compile(
        r"/dna/system/api/v1/auth/token"
    )
    APPLICATION_POLICY_fae4378ef4e2503f9fef4f3a4ddd4de4_PATTERN = re.compile(
        r"/dna/intent/api/v1/app-policy"
    )
    APPLICATION_POLICY_9d1b2e541bb85dea8192cd474be4e3ad_PATTERN = re.compile(
        r"/dna/intent/api/v1/app-policy-default"
    )
    APPLICATION_POLICY_72fa27ccbaf55711849381a707e1edfa_PATTERN = re.compile(
        r"/dna/intent/api/v1/app-policy-intent"
    )
    APPLICATION_POLICY_d47102747c9e50ed9e365b1297e4188d_PATTERN = re.compile(
        r"/dna/intent/api/v1/app-policy-queuing-profile"
    )
    APPLICATION_POLICY_b11aa4de387251c794665e030fa815da_PATTERN = re.compile(
        r"/dna/intent/api/v1/app-policy-queuing-profile"
    )
    APPLICATION_POLICY_bd31fcbd1ecd5a2c8b812088b27bfcea_PATTERN = re.compile(
        r"/dna/intent/api/v1/app-policy-queuing-profile"
    )
    APPLICATION_POLICY_a22faef865d55fe48dd2467bee214518_PATTERN = re.compile(
        r"/dna/intent/api/v1/app-policy-queuing-profile-count"
    )
    APPLICATION_POLICY_ac547ee07c2c5aff983d90cf4306619d_PATTERN = re.compile(
        r"/dna/intent/api/v1/app-policy-queuing-profile/string"
    )
    APPLICATION_POLICY_8b60dbd805b95030bc2caf345a44b504_PATTERN = re.compile(
        r"/dna/intent/api/v1/application-policy-application-set"
    )
    APPLICATION_POLICY_0a59a448c5c25f1e8246d6827e6e3215_PATTERN = re.compile(
        r"/dna/intent/api/v1/application-policy-application-set"
    )
    APPLICATION_POLICY_636cb7563a5058c4801eb842a74ff61c_PATTERN = re.compile(
        r"/dna/intent/api/v1/application-policy-application-set"
    )
    APPLICATION_POLICY_968ebc5880945305adb41253c6e4ffec_PATTERN = re.compile(
        r"/dna/intent/api/v1/application-policy-application-set-count"
    )
    APPLICATION_POLICY_e1781a990c6b5a4b895d56bcfda2b7cb_PATTERN = re.compile(
        r"/dna/intent/api/v1/applications"
    )
    APPLICATION_POLICY_a3b37dcbe2a150bea06d9dcde1837281_PATTERN = re.compile(
        r"/dna/intent/api/v1/applications"
    )
    APPLICATION_POLICY_d11d35f3505652b68905ddf1ee2f7e66_PATTERN = re.compile(
        r"/dna/intent/api/v1/applications"
    )
    APPLICATION_POLICY_5b12cdd3a75c51258c9e051e84189f92_PATTERN = re.compile(
        r"/dna/intent/api/v1/applications"
    )
    APPLICATION_POLICY_30af5f0aa1ed56ab9b98eb602dbd8366_PATTERN = re.compile(
        r"/dna/intent/api/v1/applications-count"
    )
    APPLICATION_POLICY_56001c37a46857f0bee5eba0a514091c_PATTERN = re.compile(
        r"/dna/intent/api/v1/qos-device-interface-info"
    )
    APPLICATION_POLICY_ea59df3daf2a57a0b48044cc49c8a1ca_PATTERN = re.compile(
        r"/dna/intent/api/v1/qos-device-interface-info"
    )
    APPLICATION_POLICY_d045d18062ad5ae59c6f446beb17d675_PATTERN = re.compile(
        r"/dna/intent/api/v1/qos-device-interface-info"
    )
    APPLICATION_POLICY_6349b98fe15b531dbb7e20c0f5fa61ab_PATTERN = re.compile(
        r"/dna/intent/api/v1/qos-device-interface-info-count"
    )
    APPLICATION_POLICY_629a6a5bb5935709b03d0fc37a1d47d4_PATTERN = re.compile(
        r"/dna/intent/api/v1/qos-device-interface-info/string"
    )
    APPLICATIONS_1b85e4ce533d5ff49ddd3b2f9657cfa5_PATTERN = re.compile(
        r"/dna/intent/api/v1/application-health"
    )
    AUTHENTICATION_MANAGEMENT_b19d7e8de2ca5329930d06f041a4a173_PATTERN = re.compile(
        r"/dna/intent/api/v1/certificate"
    )
    AUTHENTICATION_MANAGEMENT_c80e660c2e36582f939a7403ef15de22_PATTERN = re.compile(
        r"/dna/intent/api/v1/certificate-p12"
    )
    AUTHENTICATION_MANAGEMENT_a6bfcd88e22c5c138657b340870b4ebb_PATTERN = re.compile(
        r"/dna/system/api/v1/auth/token"
    )
    CISCO_DNA_CENTER_SYSTEM_5627d9227adc5f02b7cd264af7255d19_PATTERN = re.compile(
        r"/api/v1/onboarding/pnp-device/authorize"
    )
    CLIENTS_f2c6333d8eb05491a16c2d32095e4352_PATTERN = re.compile(
        r"/dna/intent/api/v1/client-detail"
    )
    CLIENTS_991dfd2751065bfb8c2367dd726df316_PATTERN = re.compile(
        r"/dna/intent/api/v1/client-enrichment-details"
    )
    CLIENTS_f58ddf5cee095688aed79a9bb26e21e8_PATTERN = re.compile(
        r"/dna/intent/api/v1/client-health"
    )
    CLIENTS_23c141467ea25ec0aa91cbcaff070354_PATTERN = re.compile(
        r"/dna/intent/api/v1/client-proximity"
    )
    COMMAND_RUNNER_53e946adf864590082fe3111a2a2fa74_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device-poller/cli/legit-reads"
    )
    COMMAND_RUNNER_b2dae3b41636596aa02c3ad0a4bcb8d7_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device-poller/cli/read-request"
    )
    COMPLIANCE_4a1de7ff46fa5da09c5051c06ad07f2c_PATTERN = re.compile(
        r"/dna/intent/api/v1/compliance"
    )
    COMPLIANCE_0802306a0a8d545698d1d59a9be90e51_PATTERN = re.compile(
        r"/dna/intent/api/v1/compliance/"
    )
    COMPLIANCE_079c37ce8136584f9e2ed471fc896ef9_PATTERN = re.compile(
        r"/dna/intent/api/v1/compliance/count"
    )
    COMPLIANCE_6395adeaeb8157da972efb7b91e1e2cb_PATTERN = re.compile(
        r"/dna/intent/api/v1/compliance/detail"
    )
    COMPLIANCE_d3d38fed534f5aeaa80f5a8c63694708_PATTERN = re.compile(
        r"/dna/intent/api/v1/compliance/detail/count"
    )
    COMPLIANCE_41da8e5cdd435db0b1da1684be8f15b8_PATTERN = re.compile(
        r"/dna/intent/api/v1/compliance/string"
    )
    COMPLIANCE_90b70e1b6a2f51a59690669a4b2fd3f0_PATTERN = re.compile(
        r"/dna/intent/api/v1/compliance/string/detail"
    )
    CONFIGURATION_ARCHIVE_e85b40c5ca055f4c82281617a8f95644_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device-archive/cleartext"
    )
    CONFIGURATION_TEMPLATES_feb800c6888f5b13972467f0e3416ec2_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/clone/name/string/project/string/template/string"
    )
    CONFIGURATION_TEMPLATES_8548ecc3258a5c5b8f2267a512820a59_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/project"
    )
    CONFIGURATION_TEMPLATES_cc19241fd92f586c8986d4d5c99c3a88_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/project"
    )
    CONFIGURATION_TEMPLATES_56b942797fc158e3a0fbb5ffb1347962_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/project"
    )
    CONFIGURATION_TEMPLATES_dec1857f1585557eb39e12a9c93ef985_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/project/importprojects"
    )
    CONFIGURATION_TEMPLATES_49e6ea8c5d425cf9ac77006f5593725f_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/project/name/exportprojects"
    )
    CONFIGURATION_TEMPLATES_706db7b6c4f0542aab9fe7cf5c995f83_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/project/name/string/template/importtemplates"
    )
    CONFIGURATION_TEMPLATES_c1b2c35764f2518182b3f271a29a574c_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/project/string"
    )
    CONFIGURATION_TEMPLATES_a3e0588fa1ac56d4947ae5cfc2e16a8f_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/project/string"
    )
    CONFIGURATION_TEMPLATES_e3e170003d865b9a8d76cbe1d2f268be_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/project/string/template"
    )
    CONFIGURATION_TEMPLATES_027bdc3bc8a35908aba5858e78805d22_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/template"
    )
    CONFIGURATION_TEMPLATES_7dbea7d7de125cf6b840d5032d3a5c59_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/template"
    )
    CONFIGURATION_TEMPLATES_847875efa92557c9a6c8af0a71829c7e_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/template/deploy"
    )
    CONFIGURATION_TEMPLATES_6e1f17b174e955dea2ae9d98264de307_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/template/deploy/status/string"
    )
    CONFIGURATION_TEMPLATES_dc254215fdf25cd5b7ba797e8f8faebf_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/template/exporttemplates"
    )
    CONFIGURATION_TEMPLATES_ccbf614b4b355cac929f12cc61272c1c_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/template/preview"
    )
    CONFIGURATION_TEMPLATES_13e1a76c121857a085149e62e56caadd_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/template/version"
    )
    CONFIGURATION_TEMPLATES_6d49f82923bc5dfda63adfd224e1a22f_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/template/version/string"
    )
    CONFIGURATION_TEMPLATES_c311bd3d952757b2a7b98a5bc5aa6137_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/template/string"
    )
    CONFIGURATION_TEMPLATES_d6dbb8874d3150858c1ca6feb7e09edf_PATTERN = re.compile(
        r"/dna/intent/api/v1/template-programmer/template/string"
    )
    CONFIGURATION_TEMPLATES_2074b1fbcb8a5286936915883ec1a0cc_PATTERN = re.compile(
        r"/dna/intent/api/v2/template-programmer/project"
    )
    CONFIGURATION_TEMPLATES_8915c55b3c31568294840b4b6fd8bc0a_PATTERN = re.compile(
        r"/dna/intent/api/v2/template-programmer/template"
    )
    CONFIGURATION_TEMPLATES_bf40cea4982c54278a52ac2e7b0c458a_PATTERN = re.compile(
        r"/dna/intent/api/v2/template-programmer/template/deploy"
    )
    DEVICE_ONBOARDING_PNP_734f04b76067507b9384e409e9431ef3_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device"
    )
    DEVICE_ONBOARDING_PNP_24c033291ec4591886bd6ed25f900c1b_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device"
    )
    DEVICE_ONBOARDING_PNP_2e722e05046d5262b55c125237e9b67d_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/claim"
    )
    DEVICE_ONBOARDING_PNP_17ce6d91900556839c09184d8a11c04d_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/count"
    )
    DEVICE_ONBOARDING_PNP_f03966978a7f5cd4b3228dcae71373fe_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/history"
    )
    DEVICE_ONBOARDING_PNP_a7d6d604f38f5f849af79d8768bddfc1_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/import"
    )
    DEVICE_ONBOARDING_PNP_15226f5a13405ba69f3957b98db8663a_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/reset"
    )
    DEVICE_ONBOARDING_PNP_b34f9daa98735533a61287ce30d216b6_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/sacct/string/vacct/string/sync-result"
    )
    DEVICE_ONBOARDING_PNP_e11daa984f535a08bc1eb01bc84bc399_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/site-claim"
    )
    DEVICE_ONBOARDING_PNP_fc416739f3c655ed911884aec0130e83_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/site-config-preview"
    )
    DEVICE_ONBOARDING_PNP_0768898397e350a7a690cdfeffa5eaca_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/unclaim"
    )
    DEVICE_ONBOARDING_PNP_97591ad0cce45817862bebfc839bf5ae_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/vacct-sync"
    )
    DEVICE_ONBOARDING_PNP_cec8139f6b1c5e5991d12197206029a0_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/string"
    )
    DEVICE_ONBOARDING_PNP_5cfec9657be95cac9679e5a808e95124_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/string"
    )
    DEVICE_ONBOARDING_PNP_6d2ead8063ab552ea4abcb3e947a092a_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-device/string"
    )
    DEVICE_ONBOARDING_PNP_fc8410781af357b6be17a2104ce5efb1_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-settings"
    )
    DEVICE_ONBOARDING_PNP_b37eb826a4ad5283ae85dc4628045b40_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-settings"
    )
    DEVICE_ONBOARDING_PNP_6e433c01ec815f18af40dcf05481ef52_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-settings/sacct"
    )
    DEVICE_ONBOARDING_PNP_c1a9d2c14ac255fd812d6e7aa20a57cc_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-settings/sacct/string/vacct"
    )
    DEVICE_ONBOARDING_PNP_c6774ff9549a53d4b41fdd2d88f1d0f5_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-settings/savacct"
    )
    DEVICE_ONBOARDING_PNP_bc3cb471beaf5bfeb47201993c023068_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-settings/savacct"
    )
    DEVICE_ONBOARDING_PNP_8f785e5c9b1c5690b29a65d96f6a601a_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-settings/vacct"
    )
    DEVICE_ONBOARDING_PNP_1df400c60659589599f2a0e3e1171985_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-workflow"
    )
    DEVICE_ONBOARDING_PNP_d967a378b43457ad8c6a6de7bc1845d1_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-workflow"
    )
    DEVICE_ONBOARDING_PNP_da8a788940fe59519facc6327e988922_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-workflow/count"
    )
    DEVICE_ONBOARDING_PNP_56a2b8f2239f5ef5b2e749f1b85d6508_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-workflow/string"
    )
    DEVICE_ONBOARDING_PNP_820ccaae97d6564e9a29fa5170ccd2a3_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-workflow/string"
    )
    DEVICE_ONBOARDING_PNP_4550fdd2af215b9b8327a3e24a3dea89_PATTERN = re.compile(
        r"/dna/intent/api/v1/onboarding/pnp-workflow/string"
    )
    DEVICE_REPLACEMENT_e89f8ba4965853b3a075c7401c564477_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-replacement"
    )
    DEVICE_REPLACEMENT_2b60f9f312235959812d49dc4c469e83_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-replacement"
    )
    DEVICE_REPLACEMENT_ac6e63199fb05bcf89106a22502c2197_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-replacement"
    )
    DEVICE_REPLACEMENT_c2b2882c8fb65284bfc9d781e9ddd07f_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-replacement/count"
    )
    DEVICE_REPLACEMENT_19f256e33af7501a8bdae2742ca9f6d6_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-replacement/workflow"
    )
    DEVICES_30efc372d6eb577ca47e8c86f30c3d2f_PATTERN = re.compile(
        r"/dna/intent/api/v1/buildings/string/planned-access-points"
    )
    DEVICES_560c9ee787eb5a0391309f45ddf392ca_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-detail"
    )
    DEVICES_08a20c25e0fa518bb186fd7747450ef6_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-enrichment-details"
    )
    DEVICES_c75e364632e15384a18063458e2ba0e3_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-health"
    )
    DEVICES_9a570c5ee77b59d8b9cd203e566288e1_PATTERN = re.compile(
        r"/dna/intent/api/v1/floors/string/planned-access-points"
    )
    DEVICES_22d3d71136d95562afc211b40004d109_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface"
    )
    DEVICES_0da44fbc3e415a99aac0bdd291e9a87a_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/count"
    )
    DEVICES_cf7fa95e3ed4527aa5ba8ca871a8c142_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/ip-address/string"
    )
    DEVICES_af71ea437c8755869b00d26ba9234dff_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/isis"
    )
    DEVICES_e057192b97615f0d99a10e2b66bab13a_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/network-device/string"
    )
    DEVICES_34b7d6c62ea6522081fcf55de7eb9fd7_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/network-device/string/count"
    )
    DEVICES_bef9e9b306085d879b877598fad71b51_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/network-device/string/interface-name"
    )
    DEVICES_5a3d52c630ba5deaada16fe3b07af744_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/network-device/string/0/0"
    )
    DEVICES_32a2868ff45f5621965f6ece01a742ce_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/ospf"
    )
    DEVICES_17b16bff74ae54ca88a02b34df169218_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/string"
    )
    DEVICES_2441213b887c55faaca726bbe4ac2564_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/string"
    )
    DEVICES_fe6d62edcec25921926043ca25f75bed_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/string/legit-operation"
    )
    DEVICES_399e702d5786552992aa76b930780569_PATTERN = re.compile(
        r"/dna/intent/api/v1/interface/string/operation"
    )
    DEVICES_fe602e8165035b5cbc304fada4ee2f26_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device"
    )
    DEVICES_62704fe3ec7651e79d891fce37a0d860_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device"
    )
    DEVICES_8232fe06867e548bba1919024b40d992_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device"
    )
    DEVICES_b5a5c8da4aaa526da6a06e97c80a38be_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/autocomplete"
    )
    DEVICES_aa11f09d28165f4ea6c81b8642e59cc4_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/brief"
    )
    DEVICES_ce94ab18ad505e8a9846f6c4c9df0d2b_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/collection-schedule/global"
    )
    DEVICES_ed2bca4be412527198720a4dfec9604a_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/config"
    )
    DEVICES_3dc0a72537a3578ca31cc5ef29131d35_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/config/count"
    )
    DEVICES_bbfe7340fe6752e5bc273a303d165654_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/count"
    )
    DEVICES_57e6ec627d3c587288978990aae75228_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/file"
    )
    DEVICES_ad8cea95d71352f0842a2c869765e6cf_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/functional-capability"
    )
    DEVICES_7f494532c45654fdaeda8d46a0d9753d_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/functional-capability/string"
    )
    DEVICES_eed1595442b757bf94938c858a257ced_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/insight/string/device-link"
    )
    DEVICES_bbc074b061d3575d8247084ca33c95d9_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/insight/string/insecure-connection"
    )
    DEVICES_40123dc74c2052a3a4eb7e2a01eaa8e7_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/ip-address/string"
    )
    DEVICES_ce9e547725c45c66824afda98179d12f_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/module"
    )
    DEVICES_fb11f997009751c991884b5fc02087c5_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/module/count"
    )
    DEVICES_96a4588640da5b018b499c5760f4092a_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/module/string"
    )
    DEVICES_5c53d56c282e5f108c659009d21f9d26_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/serial-number/string"
    )
    DEVICES_9425f2c120b855cb8c852806ce72e54d_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/sync"
    )
    DEVICES_8770b2c39feb5e48913492c33add7f13_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/tenantinfo/macaddress"
    )
    DEVICES_d31b0bb4bde55bb8a3078b66c81f3a22_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/user-defined-field"
    )
    DEVICES_ed266e6eda225aedbf581508635da822_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/user-defined-field"
    )
    DEVICES_119d76a951f85a7a927afc2f1ea935c8_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/user-defined-field/string"
    )
    DEVICES_6854f0f19119501094fb5fafe05dfbca_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/user-defined-field/string"
    )
    DEVICES_4a03cee8dfd7514487a134a422f5e0d7_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/chassis"
    )
    DEVICES_c07eaefa1fa45faa801764d9094336ae_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/stack"
    )
    DEVICES_c1144f7a496455f99f95d36d6474c4b4_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/user-defined-field"
    )
    DEVICES_a73fbc67627e5bbbafe748de84d42df6_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/user-defined-field"
    )
    DEVICES_520c1cb24a2b53ce8d29d119c6ee1112_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/equipment"
    )
    DEVICES_ab3215d9be065533b7cbbc978cb4d905_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/interface/poe-detail"
    )
    DEVICES_a1878314ffd35d29bea49f12d10b59c8_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/interface/string/neighbor"
    )
    DEVICES_bd31690b61f45d9f880d74d4e682b070_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/line-card"
    )
    DEVICES_f7a67aba0b365a1e9dae62d148511a25_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/poe"
    )
    DEVICES_4500eb13516155a28570e542dcf10a91_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/supervisor-card"
    )
    DEVICES_358d86f657f8592f97014d2ebf8d37ac_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string"
    )
    DEVICES_003e01233fa258e393239c4b41882806_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string"
    )
    DEVICES_fe0153ca24205608b8741d51f5a6d54a_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/brief"
    )
    DEVICES_f90daf1c279351f884ba3198d3b2d641_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/collection-schedule"
    )
    DEVICES_790b4ba6d23d5e7eb62cbba4c9e1a29d_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/meraki-organization"
    )
    DEVICES_fd5fb603cba6523abb25c8ec131fbb8b_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/vlan"
    )
    DEVICES_c01ee650fcf858789ca00c8deda969b9_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/wireless-info"
    )
    DEVICES_5af0bbf34adb5146b931ec874fc2cc40_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/string/config"
    )
    DEVICES_60d7b6ce5abd5dad837e22ace817a6f0_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/0/0"
    )
    DISCOVERY_a1d007749a7e5b99aabddf1543714a9a_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery"
    )
    DISCOVERY_f325b2c7e429566ba5ed9ae8253b5bef_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery"
    )
    DISCOVERY_fdbe4ec3e9f252a988404dc94250b80d_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery"
    )
    DISCOVERY_95e37fcf36e3539492dfb9cd21e49620_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/count"
    )
    DISCOVERY_bde1ca5763fc552ab78cd3b2ecf119b1_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/job"
    )
    DISCOVERY_1bb187b0c0a55e7e8089ac78eb29d8a2_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/string"
    )
    DISCOVERY_c4370f0a57d85355a7061d7671f1b613_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/string"
    )
    DISCOVERY_e369e19c1a835567855984d9f2c628ef_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/string/job"
    )
    DISCOVERY_f478b876b38a5cf094d80eced531b1a0_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/string/network-device"
    )
    DISCOVERY_a2f0cb47996d5bf7a3d5de89e2a002bb_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/string/network-device/count"
    )
    DISCOVERY_7fd0ae0041dc59fb8aae545a8199d7b4_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/string/network-device/0/0"
    )
    DISCOVERY_98155b212632561f886c01676b12a2b1_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/string/summary"
    )
    DISCOVERY_6cba543cfb0957e9bc38d8c7f49f3e47_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/0/0"
    )
    DISCOVERY_e847420499a7592d993b7c7dff809f0d_PATTERN = re.compile(
        r"/dna/intent/api/v1/discovery/0/0"
    )
    DISCOVERY_3ce4a30581da554591309dd423a91e7a_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential"
    )
    DISCOVERY_678669d39d23589e85db0a63c414057c_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/cli"
    )
    DISCOVERY_c524f0ec199e5435bcaee56b423532e7_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/cli"
    )
    DISCOVERY_1ffcaccdd9f2530abf66adc98c3f0201_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/http-read"
    )
    DISCOVERY_1d1845268faf55f98bc952872259f16f_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/http-read"
    )
    DISCOVERY_6f6536a8f01d5863856a0a8308198e15_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/http-write"
    )
    DISCOVERY_1f77386a48895fa59dcddcc7dd4addb5_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/http-write"
    )
    DISCOVERY_702f7cf4f24d54c6944a31ed308f8361_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/netconf"
    )
    DISCOVERY_7f5645e6e819558fa08761dee45ca406_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/netconf"
    )
    DISCOVERY_e3d7ad943d3a50fb8c3be7327669e557_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/snmpv2-read-community"
    )
    DISCOVERY_8d16471a58805b4aa2c757209d188aed_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/snmpv2-read-community"
    )
    DISCOVERY_2a3a1bf404bf5772828f66f1e10f074d_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/snmpv2-write-community"
    )
    DISCOVERY_92179760c9ea5c02b2b7368cac785f30_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/snmpv2-write-community"
    )
    DISCOVERY_2782bdc981805b5fad0a038966d52558_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/snmpv3"
    )
    DISCOVERY_ecdb2d14c29b5bf3ad79ed2e3cc70715_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/snmpv3"
    )
    DISCOVERY_a82cc61ddeae50969464f7b5d7d6bbf1_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/string"
    )
    DISCOVERY_4f5d13316c8f53a0b78d881c738a15c6_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/string"
    )
    DISCOVERY_659a37de9e4e5fab8c65b0701b074fd2_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-credential/string"
    )
    DISCOVERY_9031dfb02d27503fab05602db7311e90_PATTERN = re.compile(
        r"/dna/intent/api/v1/snmp-property"
    )
    DISCOVERY_da593242978c5047bb6b62b7f9475326_PATTERN = re.compile(
        r"/dna/intent/api/v1/snmp-property"
    )
    DISCOVERY_1b3323a24b275402b97c7e9ccfd78c91_PATTERN = re.compile(
        r"/dna/intent/api/v2/global-credential"
    )
    DISCOVERY_3573d2ece28b509b8ef80b2b8c5c5f36_PATTERN = re.compile(
        r"/dna/intent/api/v2/global-credential"
    )
    DISCOVERY_8a473a278a325c67abd310df49bae1bb_PATTERN = re.compile(
        r"/dna/intent/api/v2/global-credential"
    )
    DISCOVERY_caa7cd8d7a3550cfb102cd3498494d04_PATTERN = re.compile(
        r"/dna/intent/api/v2/global-credential/string"
    )
    EO_X_64d5d27a53ac53258fa2183b7e93a7d5_PATTERN = re.compile(
        r"/dna/intent/api/v1/eox-status/device"
    )
    EO_X_816ec048832853f8a63f34415d0e6fce_PATTERN = re.compile(
        r"/dna/intent/api/v1/eox-status/device/string"
    )
    EO_X_f0a0dfdaca465bdc91fc290d87476b89_PATTERN = re.compile(
        r"/dna/intent/api/v1/eox-status/summary"
    )
    EVENT_MANAGEMENT_9f8e3a0674c15fd58cd78f42dca37c7c_PATTERN = re.compile(
        r"/dna/data/api/v1/event/event-series/audit-log/parent-records"
    )
    EVENT_MANAGEMENT_894ea7c0220d55ae9e1a51d6823ce862_PATTERN = re.compile(
        r"/dna/data/api/v1/event/event-series/audit-log/summary"
    )
    EVENT_MANAGEMENT_b0aa5a61f64a5da997dfe05bc8a4a64f_PATTERN = re.compile(
        r"/dna/data/api/v1/event/event-series/audit-logs"
    )
    EVENT_MANAGEMENT_e1bd67a1a0225713ab23f0d0d3ceb4f6_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/api-status/string"
    )
    EVENT_MANAGEMENT_96aaebb912125213b350d7423b4f01a4_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/email-config"
    )
    EVENT_MANAGEMENT_d5f08e8ff59e51d1a9ae56c3e20eae3c_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/email-config"
    )
    EVENT_MANAGEMENT_9c991ce0b0f058a08c863a4abdfc70a6_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/email-config"
    )
    EVENT_MANAGEMENT_c641f481dd285301861010da8d6fbf9f_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/event-series"
    )
    EVENT_MANAGEMENT_4431fd269fe156e4b5ad3f4210b7b168_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/event-series/count"
    )
    EVENT_MANAGEMENT_6e698d5a990a55158003a9f3250316a8_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/snmp-config"
    )
    EVENT_MANAGEMENT_343538d7d4e55d6bbb21c34ce863a131_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription"
    )
    EVENT_MANAGEMENT_a0e0b1772dfc5a02a96a9f6ee6e2579b_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription"
    )
    EVENT_MANAGEMENT_dfda5beca4cc5437876bff366493ebf0_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription"
    )
    EVENT_MANAGEMENT_5fcc151af7615a84adf48b714d146192_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription"
    )
    EVENT_MANAGEMENT_403889d420225889bb16f99ec7ba099a_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription-details/email"
    )
    EVENT_MANAGEMENT_86272f278c72555e9a56f554b2a21c85_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription-details/rest"
    )
    EVENT_MANAGEMENT_c0dcb335458a58fa8bc5a485b174427d_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription-details/syslog"
    )
    EVENT_MANAGEMENT_c538dc50a4555b5fba17b672a89ee1b8_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription/count"
    )
    EVENT_MANAGEMENT_2e69d02d71905aecbd10b782469efbda_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription/email"
    )
    EVENT_MANAGEMENT_f8b4842604b65658afb34b4f124db469_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription/email"
    )
    EVENT_MANAGEMENT_bc212b5ee1f252479f35e8dd58319f17_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription/email"
    )
    EVENT_MANAGEMENT_9f41eb48a0da56949cfaddeecb51ab66_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription/rest"
    )
    EVENT_MANAGEMENT_1ee2008494d158e7bff7f106519a64c5_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription/rest"
    )
    EVENT_MANAGEMENT_7474456b6581534bb321eaea272365b7_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription/rest"
    )
    EVENT_MANAGEMENT_8d8fc92ddeab597ebb50ea003a6d46bd_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription/syslog"
    )
    EVENT_MANAGEMENT_99fb5a8c0075563491622171958074bf_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription/syslog"
    )
    EVENT_MANAGEMENT_c7bed4b4148753e6bc9912e3be135217_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/subscription/syslog"
    )
    EVENT_MANAGEMENT_6a9f5796226051218eac559ab5211384_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/syslog-config"
    )
    EVENT_MANAGEMENT_a170168de2ac55cc93571af1fbc02894_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/syslog-config"
    )
    EVENT_MANAGEMENT_919dece7a9b353b49084a8ffa4f18c91_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/syslog-config"
    )
    EVENT_MANAGEMENT_36b8699619f95a24bd2d81f12f048235_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/webhook"
    )
    EVENT_MANAGEMENT_d5c229546dc755f796dfcf34f1c2e290_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/webhook"
    )
    EVENT_MANAGEMENT_ddecdd64b34c5fdc910296fce09b2828_PATTERN = re.compile(
        r"/dna/intent/api/v1/event/webhook"
    )
    EVENT_MANAGEMENT_bf36f1819e61575189c0709efab6e48a_PATTERN = re.compile(
        r"/dna/intent/api/v1/events"
    )
    EVENT_MANAGEMENT_3b21d2947d715c198f5e62ba3149839a_PATTERN = re.compile(
        r"/dna/intent/api/v1/events/count"
    )
    EVENT_MANAGEMENT_584c0e0d76b2561b8f2efd0220f02267_PATTERN = re.compile(
        r"/dna/system/api/v1/event/artifact"
    )
    EVENT_MANAGEMENT_a137e0b583c85ffe80fbbd85b480bf15_PATTERN = re.compile(
        r"/dna/system/api/v1/event/artifact/count"
    )
    EVENT_MANAGEMENT_632352b94cfb5af084c1a65d8e51df71_PATTERN = re.compile(
        r"/dna/system/api/v1/event/config/connector-types"
    )
    FABRIC_WIRELESS_ad96e712f4525a128368b1bfe3afc21c_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/hostonboarding/ssid-ippool"
    )
    FABRIC_WIRELESS_249809f90ae8599c8a21c98b7a1ca804_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/hostonboarding/ssid-ippool"
    )
    FABRIC_WIRELESS_2b0f6a0410705c75a61cdc51cc96c53f_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/hostonboarding/ssid-ippool"
    )
    FABRIC_WIRELESS_76039bb706025a9cb183ce7a60e0b5df_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/wireless-controller"
    )
    FABRIC_WIRELESS_6c4befbd77a452a9b7873ffc360a1f20_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/wireless-controller"
    )
    FILE_b7fc125c901c5d4488b7a2b75fa292bc_PATTERN = re.compile(
        r"/dna/intent/api/v1/file/namespace"
    )
    FILE_b7d63a5ae65b59a5a35d43edc58b6db5_PATTERN = re.compile(
        r"/dna/intent/api/v1/file/namespace/string"
    )
    FILE_1282fa4ab7605a75aafa6c7da6ac3f13_PATTERN = re.compile(
        r"/dna/intent/api/v1/file/string"
    )
    FILE_3113e7fb3df05906b8cd6077d4d9cc5c_PATTERN = re.compile(
        r"/dna/intent/api/v1/file/string"
    )
    HEALTH_AND_PERFORMANCE_d0acccfae6885bc28f8f39c67f4acfc1_PATTERN = re.compile(
        r"/dna/intent/api/v1/diagnostics/system/health"
    )
    HEALTH_AND_PERFORMANCE_96f6dd603bc35db1948f31c782a37647_PATTERN = re.compile(
        r"/dna/intent/api/v1/diagnostics/system/health/count"
    )
    HEALTH_AND_PERFORMANCE_cfcb7a875f215cb4ba59be38abb871e6_PATTERN = re.compile(
        r"/dna/intent/api/v1/diagnostics/system/performance"
    )
    HEALTH_AND_PERFORMANCE_0f131d712dc253dca528c0298b3e41c6_PATTERN = re.compile(
        r"/dna/intent/api/v1/diagnostics/system/performance/history"
    )
    ITSM_46eb1bf346225a4ba24f18408ffca7c9_PATTERN = re.compile(
        r"/dna/intent/api/v1/cmdb-sync/detail"
    )
    ITSM_da70082b298a5a908edb780a61bd4ca6_PATTERN = re.compile(
        r"/dna/intent/api/v1/integration/events"
    )
    ITSM_25624cfb1d6e52878d057740de275896_PATTERN = re.compile(
        r"/dna/intent/api/v1/integration/events"
    )
    ITSM_INTEGRATION_2bb01b6bd31b53bfb12bbe327320392e_PATTERN = re.compile(
        r"/dna/intent/api/v1/integration-settings/instances/itsm"
    )
    ITSM_INTEGRATION_c9b5b83e67195b649077a05e42897cc4_PATTERN = re.compile(
        r"/dna/intent/api/v1/integration-settings/instances/itsm/string"
    )
    ITSM_INTEGRATION_53ca7a97d4665bca9634b6fb41cd7d29_PATTERN = re.compile(
        r"/dna/intent/api/v1/integration-settings/instances/itsm/string"
    )
    ITSM_INTEGRATION_7ae71ae83f7f530c81e650c1455567e8_PATTERN = re.compile(
        r"/dna/intent/api/v1/integration-settings/instances/itsm/string"
    )
    ITSM_INTEGRATION_ac54638bea4157f2bbd03f329ac25e27_PATTERN = re.compile(
        r"/dna/intent/api/v1/integration-settings/itsm/instances"
    )
    ISSUES_915745bc55e6552fac58cc0aaacd773a_PATTERN = re.compile(
        r"/dna/intent/api/v1/execute-suggested-actions-commands"
    )
    ISSUES_02f2f039811951c0af53e3381ae91225_PATTERN = re.compile(
        r"/dna/intent/api/v1/issue-enrichment-details"
    )
    ISSUES_759522aaef3b519ba8b9fb2cbf43b985_PATTERN = re.compile(
        r"/dna/intent/api/v1/issues"
    )
    LAN_AUTOMATION_b119a4d455e35cc3b2cc6695a045cbfa_PATTERN = re.compile(
        r"/dna/intent/api/v1/lan-automation"
    )
    LAN_AUTOMATION_130eea014edd5807925df3a414a92ed4_PATTERN = re.compile(
        r"/dna/intent/api/v1/lan-automation/count"
    )
    LAN_AUTOMATION_3173e37f6c9650b68e0aaac866a162cf_PATTERN = re.compile(
        r"/dna/intent/api/v1/lan-automation/log"
    )
    LAN_AUTOMATION_60e98b744fde50a1b53761251c43bfb0_PATTERN = re.compile(
        r"/dna/intent/api/v1/lan-automation/log/string"
    )
    LAN_AUTOMATION_26485c3441f7507a98d02579c25814f4_PATTERN = re.compile(
        r"/dna/intent/api/v1/lan-automation/log/string/string"
    )
    LAN_AUTOMATION_5a19cf2241e75c648220d7172e9e4013_PATTERN = re.compile(
        r"/dna/intent/api/v1/lan-automation/sessions"
    )
    LAN_AUTOMATION_40c56a6c58fd5b71b7949036855ee25b_PATTERN = re.compile(
        r"/dna/intent/api/v1/lan-automation/status"
    )
    LAN_AUTOMATION_d5727c4bdb1056308cd10e99dff2acb8_PATTERN = re.compile(
        r"/dna/intent/api/v1/lan-automation/status/string"
    )
    LAN_AUTOMATION_ed815ca3e5ab5ae48720795217ec776b_PATTERN = re.compile(
        r"/dna/intent/api/v1/lan-automation/string"
    )
    LICENSES_87c0cf04bdc758b29bb11abbdacbd921_PATTERN = re.compile(
        r"/dna/intent/api/v1/licenses/device/count"
    )
    LICENSES_f4ba64eef4085d518a612835e128fe3c_PATTERN = re.compile(
        r"/dna/intent/api/v1/licenses/device/summary"
    )
    LICENSES_6f04f865c01d5c17a5f0cb5abe620dd8_PATTERN = re.compile(
        r"/dna/intent/api/v1/licenses/device/string/details"
    )
    LICENSES_0109b2f15d0c54c2862a60a904289ddd_PATTERN = re.compile(
        r"/dna/intent/api/v1/licenses/smartAccount/virtualAccount/deregister"
    )
    LICENSES_df26f516755a50b5b5477324cf5cb649_PATTERN = re.compile(
        r"/dna/intent/api/v1/licenses/smartAccount/virtualAccount/string/register"
    )
    LICENSES_4bd5b507f58a50aab614e3d7409eec4c_PATTERN = re.compile(
        r"/dna/intent/api/v1/licenses/smartAccount/string/virtualAccount/string/device/transfer"
    )
    LICENSES_8ab450b197375fa9bcd95219113a3075_PATTERN = re.compile(
        r"/dna/intent/api/v1/licenses/smartAccount/string/virtualAccounts"
    )
    LICENSES_ea3fdbde23325051a76b9d062c2962a0_PATTERN = re.compile(
        r"/dna/intent/api/v1/licenses/smartAccounts"
    )
    LICENSES_df2d278e89b45c8ea0ca0a945c001f08_PATTERN = re.compile(
        r"/dna/intent/api/v1/licenses/term/smartAccount/string/virtualAccount/string"
    )
    LICENSES_46e55ecbbda454c6a01d905e6f4cce16_PATTERN = re.compile(
        r"/dna/intent/api/v1/licenses/usage/smartAccount/string/virtualAccount/string"
    )
    NETWORK_SETTINGS_4e4f91ea42515ccdbc24549b84ca1e90_PATTERN = re.compile(
        r"/dna/intent/api/v1/credential-to-site/string"
    )
    NETWORK_SETTINGS_903cf2cac6f150c9bee9ade37921b162_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-credential"
    )
    NETWORK_SETTINGS_722d7161b33157dba957ba18eda440c2_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-credential"
    )
    NETWORK_SETTINGS_403067d8cf995d9d99bdc31707817456_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-credential"
    )
    NETWORK_SETTINGS_598e8e021f1c51eeaf0d102084481486_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-credential/string"
    )
    NETWORK_SETTINGS_ebdcd84fc41754a69eaeacf7c0b0731c_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-pool"
    )
    NETWORK_SETTINGS_5c380301e3e05423bdc1857ff00ae77a_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-pool"
    )
    NETWORK_SETTINGS_eecf4323cb285985be72a7e061891059_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-pool"
    )
    NETWORK_SETTINGS_61f9079863c95acd945c51f728cbf81f_PATTERN = re.compile(
        r"/dna/intent/api/v1/global-pool/string"
    )
    NETWORK_SETTINGS_40397b199c175281977a7e9e6bd9255b_PATTERN = re.compile(
        r"/dna/intent/api/v1/network"
    )
    NETWORK_SETTINGS_6eca62ef076b5627a85b2a5959613fb8_PATTERN = re.compile(
        r"/dna/intent/api/v1/network/string"
    )
    NETWORK_SETTINGS_e1b8c435195d56368c24a54dcce007d0_PATTERN = re.compile(
        r"/dna/intent/api/v1/network/string"
    )
    NETWORK_SETTINGS_274851d84253559e9d3e81881a4bd2fc_PATTERN = re.compile(
        r"/dna/intent/api/v1/reserve-ip-subpool"
    )
    NETWORK_SETTINGS_eabbb425255a57578e9db00cda1f303a_PATTERN = re.compile(
        r"/dna/intent/api/v1/reserve-ip-subpool/string"
    )
    NETWORK_SETTINGS_700808cec6c85d9bb4bcc8f61f31296b_PATTERN = re.compile(
        r"/dna/intent/api/v1/reserve-ip-subpool/string"
    )
    NETWORK_SETTINGS_07fd6083b0c65d03b2d53f10b3ece59d_PATTERN = re.compile(
        r"/dna/intent/api/v1/reserve-ip-subpool/string"
    )
    NETWORK_SETTINGS_69dda850a0675b888048adf8d488aec1_PATTERN = re.compile(
        r"/dna/intent/api/v1/service-provider"
    )
    NETWORK_SETTINGS_1ffa347eb411567a9c793696795250a5_PATTERN = re.compile(
        r"/dna/intent/api/v1/service-provider"
    )
    NETWORK_SETTINGS_03e22c99a82f5764828810acb45e7a9e_PATTERN = re.compile(
        r"/dna/intent/api/v1/service-provider"
    )
    NETWORK_SETTINGS_35598a1d68f15e02adc37239b3fcbbb6_PATTERN = re.compile(
        r"/dna/intent/api/v1/sp-profile/string"
    )
    NETWORK_SETTINGS_156a3954b27e5eeb82789ed231e0557f_PATTERN = re.compile(
        r"/dna/intent/api/v2/credential-to-site/string"
    )
    NETWORK_SETTINGS_d0b7bffe821755dab4e2a2df8ea79404_PATTERN = re.compile(
        r"/dna/intent/api/v2/network"
    )
    NETWORK_SETTINGS_c5f97865727857d5b1eeaedee3dcccd2_PATTERN = re.compile(
        r"/dna/intent/api/v2/network/string"
    )
    NETWORK_SETTINGS_a7935eedd53a5b8c84668c903cc1c705_PATTERN = re.compile(
        r"/dna/intent/api/v2/network/string"
    )
    NETWORK_SETTINGS_a66db26df529597c84c2a15ea2d632ce_PATTERN = re.compile(
        r"/dna/intent/api/v2/service-provider"
    )
    NETWORK_SETTINGS_53680237e0b654c39dc6e19cd6f5194d_PATTERN = re.compile(
        r"/dna/intent/api/v2/service-provider"
    )
    NETWORK_SETTINGS_3907f01025635a52bdfdac7226911b31_PATTERN = re.compile(
        r"/dna/intent/api/v2/service-provider"
    )
    NETWORK_SETTINGS_a9bbbce953615baeb0a324c61753139d_PATTERN = re.compile(
        r"/dna/intent/api/v2/sp-profile/string"
    )
    PATH_TRACE_a75e4b27171c5c6782e84f902da9e5be_PATTERN = re.compile(
        r"/dna/intent/api/v1/flow-analysis"
    )
    PATH_TRACE_a54fce1a0c305bdabfe91a8a6161e539_PATTERN = re.compile(
        r"/dna/intent/api/v1/flow-analysis"
    )
    PATH_TRACE_ed5cbafc332a5efa97547736ba8b6044_PATTERN = re.compile(
        r"/dna/intent/api/v1/flow-analysis/string"
    )
    PATH_TRACE_8a7ae984f943507ba621abe155e6e744_PATTERN = re.compile(
        r"/dna/intent/api/v1/flow-analysis/string"
    )
    PLATFORM_0c3bdcd996dd5d988d0d77ce8f732014_PATTERN = re.compile(
        r"/dna/intent/api/v1/dnac-packages"
    )
    PLATFORM_63206c9b144b5dc2ba26e51798f8bede_PATTERN = re.compile(
        r"/dna/intent/api/v1/dnac-release"
    )
    PLATFORM_0f0c26c266e552d6b0f1f68da8e60e16_PATTERN = re.compile(
        r"/dna/intent/api/v1/nodes-config"
    )
    REPORTS_220fa310ab095148bdb00d7d3d5e1676_PATTERN = re.compile(
        r"/dna/intent/api/v1/data/reports"
    )
    REPORTS_095d89e1c3e150ef9faaff44fa483de5_PATTERN = re.compile(
        r"/dna/intent/api/v1/data/reports"
    )
    REPORTS_76f9cb7c424b5502b4ad54ccbb1ca4f4_PATTERN = re.compile(
        r"/dna/intent/api/v1/data/reports/string"
    )
    REPORTS_8a6a151b68d450dfaf1e8a92e0f5cc68_PATTERN = re.compile(
        r"/dna/intent/api/v1/data/reports/string"
    )
    REPORTS_a4b1ca0320185570bc12da238f0e88bb_PATTERN = re.compile(
        r"/dna/intent/api/v1/data/reports/string/executions"
    )
    REPORTS_2921b2790cdb5abf98c8e00011de86a4_PATTERN = re.compile(
        r"/dna/intent/api/v1/data/reports/string/executions/string"
    )
    REPORTS_bbff833d5d5756698f4764a9d488cc98_PATTERN = re.compile(
        r"/dna/intent/api/v1/data/view-groups"
    )
    REPORTS_c5879612ddc05cd0a0de09d29da4907e_PATTERN = re.compile(
        r"/dna/intent/api/v1/data/view-groups/string"
    )
    REPORTS_3d1944177c95598ebd1986582dc8069a_PATTERN = re.compile(
        r"/dna/intent/api/v1/data/view-groups/string/views/string"
    )
    SDA_e414dcbeeabd5a359352a0e2ad5ec3f5_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/authentication-profile"
    )
    SDA_d1d42ef2f1895a82a2830bf1353e6baa_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/authentication-profile"
    )
    SDA_0d999a1d36ee52babb6b619877dad734_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/authentication-profile"
    )
    SDA_916231b2be8b5dda8b81620b903afe9f_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/authentication-profile"
    )
    SDA_b6f2d8e46cdd5f05bb06f52cd1b26fb2_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/border-device"
    )
    SDA_7aae881ff75d5488a5325ea949be4c5b_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/border-device"
    )
    SDA_9a102ba155e35f84b7af3396aa407d02_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/border-device"
    )
    SDA_6c05702ed7075a2f9ab14c051f1ac883_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/control-plane-device"
    )
    SDA_c1a89e4a8ff15608bc6c10d7ef7389d7_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/control-plane-device"
    )
    SDA_54ae7f02a3d051f2baf7cc087990d658_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/control-plane-device"
    )
    SDA_d12790f461c553a08142ec740db5efbf_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/device"
    )
    SDA_1ea24b22ce355a229b7fd067401ddf3a_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/device/role"
    )
    SDA_e0c7b28d55c85d49a84c1403ca14bd5f_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/edge-device"
    )
    SDA_409b70d8c6f85254a053ab281fd9e8fc_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/edge-device"
    )
    SDA_5a2ee396d6595001acfbbcdfa25093ff_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/edge-device"
    )
    SDA_0d23f3e54f8c59caac3ca905f7bf543a_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/fabric-site"
    )
    SDA_9124f9db3b115f0b8c8b3ce14bc5f975_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/fabric-site"
    )
    SDA_9a764c85d8df5c30b9143619d4f9cde9_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/fabric-site"
    )
    SDA_e4a09bf566f35babad9e27f5eb61a86d_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/hostonboarding/access-point"
    )
    SDA_27bd26b08b64545bae20f60c56891576_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/hostonboarding/access-point"
    )
    SDA_b035b0b3b60b5f2bb7c8c82e7f94b63b_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/hostonboarding/access-point"
    )
    SDA_072cb88b50dd5ead96ecfb4ab0390f47_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/hostonboarding/user-device"
    )
    SDA_3af29516f0c8591da2a92523b5ab3386_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/hostonboarding/user-device"
    )
    SDA_a446d7327733580e9a6b661715eb4c09_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/hostonboarding/user-device"
    )
    SDA_b7079a38844e56dd8f1b6b876880a02e_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/multicast"
    )
    SDA_55c27bbb42365955bc210924e1362c34_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/multicast"
    )
    SDA_45e8e007d3e25f7fb83a6579016aea72_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/multicast"
    )
    SDA_e5bd8dbbf65253f0aadd77a62b1b8b58_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/provision-device"
    )
    SDA_fd488ff002115f3b8f0ee165e5347609_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/provision-device"
    )
    SDA_7750d1608b2751c883a072ee3fb80228_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/provision-device"
    )
    SDA_d8f10868c21856eab31776f109aba2bb_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/provision-device"
    )
    SDA_770a34aab91750028f4d584d36811844_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/transit-peer-network"
    )
    SDA_6d39e10793a45d3db229d6d3820c665a_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/transit-peer-network"
    )
    SDA_096d7073129453698264e7519d82991c_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/transit-peer-network"
    )
    SDA_176cb9f8ad5359b2b2cbc151ac3a842a_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/virtual-network"
    )
    SDA_cb1fe08692b85767a42b84340c4c7d53_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/virtual-network"
    )
    SDA_15e3a724a35854758d65a83823c88435_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/virtual-network"
    )
    SDA_ccf5ce99e049525f8184fcaa5991d919_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/virtual-network/summary"
    )
    SDA_b88723912610599ba42292db52d1dae4_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/virtualnetwork/ippool"
    )
    SDA_951c923d016d5401b7a9943724df3844_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/virtualnetwork/ippool"
    )
    SDA_62b07f187b7456c8bbb6088a2f24dcee_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/sda/virtualnetwork/ippool"
    )
    SDA_72472f5ebb9d50aab287f320d32181c0_PATTERN = re.compile(
        r"/dna/intent/api/v1/virtual-network"
    )
    SDA_2f2e8552eabc5e5f97e1f40bcc4b4c75_PATTERN = re.compile(
        r"/dna/intent/api/v1/virtual-network"
    )
    SDA_ea4b1c052b855bd9a0e99f803e6185a5_PATTERN = re.compile(
        r"/dna/intent/api/v1/virtual-network"
    )
    SDA_f9492367570c5f009cf8b5955790e87c_PATTERN = re.compile(
        r"/dna/intent/api/v1/virtual-network"
    )
    SECURITY_ADVISORIES_4e6317a46c835f0881f08071959bb026_PATTERN = re.compile(
        r"/dna/intent/api/v1/security-advisory/advisory"
    )
    SECURITY_ADVISORIES_8947b24a5127510a8070b0f893494543_PATTERN = re.compile(
        r"/dna/intent/api/v1/security-advisory/advisory/aggregate"
    )
    SECURITY_ADVISORIES_cbdf8887b29b5f0ea87113d2ae17d6df_PATTERN = re.compile(
        r"/dna/intent/api/v1/security-advisory/advisory/string/device"
    )
    SECURITY_ADVISORIES_34b1c03688485b44b1547c428a887c5d_PATTERN = re.compile(
        r"/dna/intent/api/v1/security-advisory/device/string"
    )
    SECURITY_ADVISORIES_7cf75923b0c6575ead874f9d404d7355_PATTERN = re.compile(
        r"/dna/intent/api/v1/security-advisory/device/string/advisory"
    )
    SENSORS_e2f9718de3d050819cdc6355a3a43200_PATTERN = re.compile(
        r"/dna/intent/api/v1/AssuranceScheduleSensorTest"
    )
    SENSORS_6f7dd6a6cf8d57499168aae05847ad34_PATTERN = re.compile(
        r"/dna/intent/api/v1/sensor"
    )
    SENSORS_a1c0ac4386555300b7f4a541d8dba625_PATTERN = re.compile(
        r"/dna/intent/api/v1/sensor"
    )
    SENSORS_49925cda740c5bdc92fd150c334d0e4e_PATTERN = re.compile(
        r"/dna/intent/api/v1/sensor"
    )
    SENSORS_cfadc5e4c912588389f4f63d2fb6e4ed_PATTERN = re.compile(
        r"/dna/intent/api/v1/sensor-run-now"
    )
    SENSORS_a352f6280e445075b3ea7cbf868c2d94_PATTERN = re.compile(
        r"/dna/intent/api/v1/sensorTestTemplate"
    )
    SITE_DESIGN_cc72e307e5df50c48ce57370f27395a0_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/nfv"
    )
    SITE_DESIGN_2bfde206eb445821a5722511f138814a_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/nfv/provisioningDetail"
    )
    SITE_DESIGN_378a1800508058e4b82a08ea5637b794_PATTERN = re.compile(
        r"/dna/intent/api/v1/networkprofile/string/site/string"
    )
    SITE_DESIGN_21c8936d6a0c54e89b471fe36bf28de8_PATTERN = re.compile(
        r"/dna/intent/api/v1/networkprofile/string/site/string"
    )
    SITE_DESIGN_497d9ccfce8451809129ec5de42c5048_PATTERN = re.compile(
        r"/dna/intent/api/v1/nfv-provision-detail"
    )
    SITE_DESIGN_d2a712eb315650618d475db5de0aabec_PATTERN = re.compile(
        r"/dna/intent/api/v1/nfv/network-profile"
    )
    SITE_DESIGN_159612e2202e5f7586e68778ed7772b1_PATTERN = re.compile(
        r"/dna/intent/api/v1/nfv/network-profile/string"
    )
    SITE_DESIGN_f50579d855255df89ab3545de9745545_PATTERN = re.compile(
        r"/dna/intent/api/v1/nfv/network-profile/string"
    )
    SITE_DESIGN_89252bcefb205d26b9aced6dc6d8c269_PATTERN = re.compile(
        r"/dna/intent/api/v1/nfv/network-profile/string"
    )
    SITES_0a544e27e18e5412af3b68d915c8ca50_PATTERN = re.compile(
        r"/dna/intent/api/v1/assign-device-to-site/string/device"
    )
    SITES_63284ca11e0b5f8d91395e2462a9cfdc_PATTERN = re.compile(
        r"/dna/intent/api/v1/membership/string"
    )
    SITES_bce8e6b307ce52dd8f5546fbd78e05ee_PATTERN = re.compile(
        r"/dna/intent/api/v1/site"
    )
    SITES_dbdd6074bedc59b9a3edd6477897d659_PATTERN = re.compile(
        r"/dna/intent/api/v1/site"
    )
    SITES_ae4b592f66035f24b55028f79c1b7290_PATTERN = re.compile(
        r"/dna/intent/api/v1/site-health"
    )
    SITES_e7a025fbe2c452fc82eedd5c50104aba_PATTERN = re.compile(
        r"/dna/intent/api/v1/site/count"
    )
    SITES_27df9908ad265e83ab77d73803925678_PATTERN = re.compile(
        r"/dna/intent/api/v1/site/string"
    )
    SITES_ba5567f03dea5b6891957dd410319e3f_PATTERN = re.compile(
        r"/dna/intent/api/v1/site/string"
    )
    SOFTWARE_IMAGE_MANAGEMENT_SWIM_22891a9136d5513985f15e91a19da66c_PATTERN = (
        re.compile(r"/dna/intent/api/v1/image/activation/device")
    )
    SOFTWARE_IMAGE_MANAGEMENT_SWIM_6c8d11fb9fc752ab8bb8e2b1413ccc92_PATTERN = (
        re.compile(r"/dna/intent/api/v1/image/distribution")
    )
    SOFTWARE_IMAGE_MANAGEMENT_SWIM_039f73101d5d5e409f571084ab4c6049_PATTERN = (
        re.compile(r"/dna/intent/api/v1/image/importation")
    )
    SOFTWARE_IMAGE_MANAGEMENT_SWIM_b5c47f316ff058eb979bdea047f9d5b5_PATTERN = (
        re.compile(r"/dna/intent/api/v1/image/importation/device-family-identifiers")
    )
    SOFTWARE_IMAGE_MANAGEMENT_SWIM_a9b864257b965fe4bd8b0293f41f1537_PATTERN = (
        re.compile(r"/dna/intent/api/v1/image/importation/golden")
    )
    SOFTWARE_IMAGE_MANAGEMENT_SWIM_2405e9dd960c5378ab442f235c8135d0_PATTERN = re.compile(
        r"/dna/intent/api/v1/image/importation/golden/site/string/family/string/role/string/image/string"
    )
    SOFTWARE_IMAGE_MANAGEMENT_SWIM_97ab6266cac654d394cf943a161fcc7b_PATTERN = re.compile(
        r"/dna/intent/api/v1/image/importation/golden/site/string/family/string/role/string/image/string"
    )
    SOFTWARE_IMAGE_MANAGEMENT_SWIM_2399c1cf6d5d5f0fa2e92539134b6c1d_PATTERN = (
        re.compile(r"/dna/intent/api/v1/image/importation/source/file")
    )
    SOFTWARE_IMAGE_MANAGEMENT_SWIM_7be8cdb967555fcca03a4c1f796eee56_PATTERN = (
        re.compile(r"/dna/intent/api/v1/image/importation/source/url")
    )
    SYSTEM_SETTINGS_f7cc2592721f5b9b9f99795a26130147_PATTERN = re.compile(
        r"/dna/intent/api/v1/authentication-policy-servers"
    )
    SYSTEM_SETTINGS_ada20dc4915d5901b50634628392e79f_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/custom-prompt"
    )
    SYSTEM_SETTINGS_d2ea814bfae85da1b77872d095fc8221_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-device/custom-prompt"
    )
    ...
    TAG_afb52259f7c3501ca4d8ccd277828658_PATTERN = re.compile(
        r"/dna/intent/api/v1/tag/count"
    )
    TAG_e3934b0fb68a5ff787e65e9b7c8e6296_PATTERN = re.compile(
        r"/dna/intent/api/v1/tag/member"
    )
    TAG_9baf47897d525e5899f62e4d5bdd260b_PATTERN = re.compile(
        r"/dna/intent/api/v1/tag/member/type"
    )
    TAG_153ed48fc373506cb1688cff36c2cb0f_PATTERN = re.compile(
        r"/dna/intent/api/v1/tag/string"
    )
    TAG_4d65f9b9d8ad5426bdf7e55461fcf761_PATTERN = re.compile(
        r"/dna/intent/api/v1/tag/string"
    )
    TAG_ff12c50ea3fb53c9a53f9c9e2c595d44_PATTERN = re.compile(
        r"/dna/intent/api/v1/tag/string/member"
    )
    TAG_dcc43be0514e50fea80cfa827f13ee5c_PATTERN = re.compile(
        r"/dna/intent/api/v1/tag/string/member"
    )
    TAG_82ffacb52f745c15b40b9b352754e2e1_PATTERN = re.compile(
        r"/dna/intent/api/v1/tag/string/member/count"
    )
    TAG_5581cc9883be5c1cad1959347babb342_PATTERN = re.compile(
        r"/dna/intent/api/v1/tag/string/member/string"
    )
    TASK_0ffc19ddea705526b7d9db01baf4997e_PATTERN = re.compile(
        r"/dna/intent/api/v1/dnacaap/management/execution-status/string"
    )
    TASK_75ff485556f6504d8443789f42098be7_PATTERN = re.compile(
        r"/dna/intent/api/v1/task"
    )
    TASK_8d0586946be75e0f9f2c170217d45a28_PATTERN = re.compile(
        r"/dna/intent/api/v1/task/count"
    )
    TASK_d95c21e41dce5a9dbee07d33eefef2b2_PATTERN = re.compile(
        r"/dna/intent/api/v1/task/operation/string/0/0"
    )
    TASK_8009857899a75ba5a6bae1d568700bd3_PATTERN = re.compile(
        r"/dna/intent/api/v1/task/string"
    )
    TASK_8fa2865e229b536aacd59585a1d29704_PATTERN = re.compile(
        r"/dna/intent/api/v1/task/string/tree"
    )
    TOPOLOGY_4b0753b63045528194f2f5bbf8ae432d_PATTERN = re.compile(
        r"/dna/intent/api/v1/network-health"
    )
    TOPOLOGY_392b3f79d3b45b98849d9180cc08018e_PATTERN = re.compile(
        r"/dna/intent/api/v1/topology/l2/string"
    )
    TOPOLOGY_c7e9c39880735e7684291bc5dc3ba994_PATTERN = re.compile(
        r"/dna/intent/api/v1/topology/l3/string"
    )
    TOPOLOGY_4199688eb4ab5a978fe8785516c8af42_PATTERN = re.compile(
        r"/dna/intent/api/v1/topology/physical-topology"
    )
    TOPOLOGY_f7abdb7ab46a5918a74e839488ff6ae0_PATTERN = re.compile(
        r"/dna/intent/api/v1/topology/site-topology"
    )
    TOPOLOGY_fb6000ce8d8854bc80be3803b8dee1b7_PATTERN = re.compile(
        r"/dna/intent/api/v1/topology/vlan/vlan-names"
    )
    USERAND_ROLES_9ec0b30eca9d540a845848cffd7c602a_PATTERN = re.compile(
        r"/dna/system/api/v1/role/permissions"
    )
    USERAND_ROLES_bef02e8f6f8354dc99e375826a87c88c_PATTERN = re.compile(
        r"/dna/system/api/v1/roles"
    )
    USERAND_ROLES_7fa405b6d1be56739f2dfeea63212015_PATTERN = re.compile(
        r"/dna/system/api/v1/user"
    )
    USERAND_ROLES_6d82755e5e03510daf0951c1f42c2702_PATTERN = re.compile(
        r"/dna/system/api/v1/user"
    )
    USERAND_ROLES_34d2bd5f05bd535a89ebadb30e2ede9e_PATTERN = re.compile(
        r"/dna/system/api/v1/user"
    )
    USERAND_ROLES_452738def9045d4d9c96bcd42172a79c_PATTERN = re.compile(
        r"/dna/system/api/v1/users/external-servers"
    )
    USERS_70f9c1d861a051b4a4928f2e6d84b2e3_PATTERN = re.compile(
        r"/dna/intent/api/v1/user-enrichment-details"
    )
    WIRELESS_dde2b077d6d052dcae5a76f4aac09c1d_PATTERN = re.compile(
        r"/dna/intent/api/v1/AssuranceGetSensorTestResults"
    )
    WIRELESS_d825ae9a117f5b6bb65b7d78fd42513c_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/ssid"
    )
    WIRELESS_8e56eb2c294159d891b7dbe493ddc434_PATTERN = re.compile(
        r"/dna/intent/api/v1/business/ssid/string/string"
    )
    WIRELESS_858f5602b2965e53b5bdda193025a3fc_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-reboot/apreboot"
    )
    WIRELESS_1ebabf7f1ce2537f8aedd93e5f5aab1b_PATTERN = re.compile(
        r"/dna/intent/api/v1/device-reboot/apreboot/status"
    )
    WIRELESS_fb757e8fce4b51ffa0ba1a8e5ae4d8c0_PATTERN = re.compile(
        r"/dna/intent/api/v1/enterprise-ssid"
    )
    WIRELESS_bc33daf690ec5399a507829abfc4fe64_PATTERN = re.compile(
        r"/dna/intent/api/v1/enterprise-ssid"
    )
    WIRELESS_25479623a94058a99acaaf8eb73c9227_PATTERN = re.compile(
        r"/dna/intent/api/v1/enterprise-ssid"
    )
    WIRELESS_6a43afa4d91a5043996c682a7a7a2d62_PATTERN = re.compile(
        r"/dna/intent/api/v1/enterprise-ssid/string"
    )
    WIRELESS_9610a850fb6c5451a7ad20ba76f4ff43_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless-profile/string"
    )
    WIRELESS_6e0bd567c1395531a7f18ab4e14110bd_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/accesspoint-configuration"
    )
    WIRELESS_435cc2c3a5b75a4091350fa84ac872c9_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/accesspoint-configuration/details/string"
    )
    WIRELESS_0fb7514b0e8c52be8cfd19dab5e31b06_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/accesspoint-configuration/summary"
    )
    WIRELESS_09f790a930d452708353c374f5c0f90f_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/ap-provision"
    )
    WIRELESS_36c00df3623b5a74ad41e75487ed9b77_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/dynamic-interface"
    )
    WIRELESS_2583c9fb8b0f5c69ba22f920e4044538_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/dynamic-interface"
    )
    WIRELESS_82bfd78707835bc8934cf0df1b0169fc_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/dynamic-interface/string"
    )
    WIRELESS_5135bbf7ce025bc2a291b90c37a6b898_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/profile"
    )
    WIRELESS_b95201b6a6905a10b463e036bf591166_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/profile"
    )
    WIRELESS_bbc1866a50505c0695ae243718d51936_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/profile"
    )
    WIRELESS_d0aab00569b258b481afedc35e6db392_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/provision"
    )
    WIRELESS_359718e31c795964b3bdf85da1b5a2a5_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/provision"
    )
    WIRELESS_f99c96c3a9b45ddaabc2c75ff8efa67f_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/psk-override"
    )
    WIRELESS_ac37d6798c0b593088952123df03bb1b_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/rf-profile"
    )
    WIRELESS_5f24f6c07641580ba6ed710e92c2da16_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/rf-profile"
    )
    WIRELESS_97f3790386da5cd49480cb0503e59047_PATTERN = re.compile(
        r"/dna/intent/api/v1/wireless/rf-profile/string"
    )

    def matches_AUTHENTICATION_ac8ae94c4e69a09d(self):
        return re.search(self.AUTHENTICATION_ac8ae94c4e69a09d_PATTERN, self.path)
    ...
    def authentication_authentication_response(self):
        ...
        response_content = json.dumps(
            {
                "Token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..WuKZUPJZgqZeKCG9UZ_C22Up1Yp7CKbImjmc9Is0xEuiy2TsB07Jl7Ov__oabNhuM2KjQyrj7k62zaopg7GyC3JGkpU7-vhYdy2c1aIBLoeeEYKOJocEE-ImUeVtFqo3md3lzMVn9hdfwQkyIuU_GwXHrDrxXY9umHKiWm9aGuP1VgRpqJKxTTsHF2iLQjmgVNHon4qqBv3McjlDNZ5nBVUzvO143xQ0ztHjebFrGGBogCt4hTVbqTdaFLowW6ovdA2qt6gktjr709gkZUkxLfa5Ntbt7DjQ-HmSTZmZHIItf2RVx9P3ENvr9RQFAQ5nWCr-rMeXceyWKr9uj75Oeg"
            }
        )
    ...
    def matches_APPLICATION_POLICY_fae4378ef4e2503f9fef4f3a4ddd4de4(self):
        return re.search(
            self.APPLICATION_POLICY_fae4378ef4e2503f9fef4f3a4ddd4de4_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_9d1b2e541bb85dea8192cd474be4e3ad(self):
        return re.search(
            self.APPLICATION_POLICY_9d1b2e541bb85dea8192cd474be4e3ad_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_72fa27ccbaf55711849381a707e1edfa(self):
        return re.search(
            self.APPLICATION_POLICY_72fa27ccbaf55711849381a707e1edfa_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_d47102747c9e50ed9e365b1297e4188d(self):
        return re.search(
            self.APPLICATION_POLICY_d47102747c9e50ed9e365b1297e4188d_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_b11aa4de387251c794665e030fa815da(self):
        return re.search(
            self.APPLICATION_POLICY_b11aa4de387251c794665e030fa815da_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_bd31fcbd1ecd5a2c8b812088b27bfcea(self):
        return re.search(
            self.APPLICATION_POLICY_bd31fcbd1ecd5a2c8b812088b27bfcea_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_a22faef865d55fe48dd2467bee214518(self):
        return re.search(
            self.APPLICATION_POLICY_a22faef865d55fe48dd2467bee214518_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_ac547ee07c2c5aff983d90cf4306619d(self):
        return re.search(
            self.APPLICATION_POLICY_ac547ee07c2c5aff983d90cf4306619d_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_8b60dbd805b95030bc2caf345a44b504(self):
        return re.search(
            self.APPLICATION_POLICY_8b60dbd805b95030bc2caf345a44b504_PATTERN, self.path
        )
        ...
        response_content = json.dumps(
            {
                "response": [
                    {
                        "id": "string",
                        "identitySource": {"id": "string", "type": "string"},
                        "name": "string",
                    }
                ]
            }
    ...
    def matches_APPLICATION_POLICY_0a59a448c5c25f1e8246d6827e6e3215(self):
        return re.search(
            self.APPLICATION_POLICY_0a59a448c5c25f1e8246d6827e6e3215_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_636cb7563a5058c4801eb842a74ff61c(self):
        return re.search(
            self.APPLICATION_POLICY_636cb7563a5058c4801eb842a74ff61c_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_968ebc5880945305adb41253c6e4ffec(self):
        return re.search(
            self.APPLICATION_POLICY_968ebc5880945305adb41253c6e4ffec_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_e1781a990c6b5a4b895d56bcfda2b7cb(self):
        return re.search(
            self.APPLICATION_POLICY_e1781a990c6b5a4b895d56bcfda2b7cb_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_a3b37dcbe2a150bea06d9dcde1837281(self):
        return re.search(
            self.APPLICATION_POLICY_a3b37dcbe2a150bea06d9dcde1837281_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_d11d35f3505652b68905ddf1ee2f7e66(self):
        return re.search(
            self.APPLICATION_POLICY_d11d35f3505652b68905ddf1ee2f7e66_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_5b12cdd3a75c51258c9e051e84189f92(self):
        return re.search(
            self.APPLICATION_POLICY_5b12cdd3a75c51258c9e051e84189f92_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_30af5f0aa1ed56ab9b98eb602dbd8366(self):
        return re.search(
            self.APPLICATION_POLICY_30af5f0aa1ed56ab9b98eb602dbd8366_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_56001c37a46857f0bee5eba0a514091c(self):
        return re.search(
            self.APPLICATION_POLICY_56001c37a46857f0bee5eba0a514091c_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_ea59df3daf2a57a0b48044cc49c8a1ca(self):
        return re.search(
            self.APPLICATION_POLICY_ea59df3daf2a57a0b48044cc49c8a1ca_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_d045d18062ad5ae59c6f446beb17d675(self):
        return re.search(
            self.APPLICATION_POLICY_d045d18062ad5ae59c6f446beb17d675_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_6349b98fe15b531dbb7e20c0f5fa61ab(self):
        return re.search(
            self.APPLICATION_POLICY_6349b98fe15b531dbb7e20c0f5fa61ab_PATTERN, self.path
        )
    ...
    def matches_APPLICATION_POLICY_629a6a5bb5935709b03d0fc37a1d47d4(self):
        return re.search(
            self.APPLICATION_POLICY_629a6a5bb5935709b03d0fc37a1d47d4_PATTERN, self.path
        )
    ...
    def matches_APPLICATIONS_1b85e4ce533d5ff49ddd3b2f9657cfa5(self):
        return re.search(
            self.APPLICATIONS_1b85e4ce533d5ff49ddd3b2f9657cfa5_PATTERN, self.path
        )
    ...
    def matches_CISCO_DNA_CENTER_SYSTEM_5627d9227adc5f02b7cd264af7255d19(self):
        return re.search(
            self.CISCO_DNA_CENTER_SYSTEM_5627d9227adc5f02b7cd264af7255d19_PATTERN,
            self.path,
        )

    def cisco_dna_center_system_authorize_device_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header("Content-Type", "application/json; charset=utf-8")
    ...
    def matches_CLIENTS_f2c6333d8eb05491a16c2d32095e4352(self):
        return re.search(
            self.CLIENTS_f2c6333d8eb05491a16c2d32095e4352_PATTERN, self.path
        )
        ...
        response_content = json.dumps(
            {
                "detail": {
                    ...
                    "lastUpdated": 0,
                    "healthScore": [
                        {"healthType": "string", "reason": "string", "score": 0}
                    ],
                    "hostMac": "string",
                    "hostIpV4": "string",
                    "hostIpV6": ["string"],
    ...
    def matches_CLIENTS_991dfd2751065bfb8c2367dd726df316(self):
        return re.search(
            self.CLIENTS_991dfd2751065bfb8c2367dd726df316_PATTERN, self.path
        )
    ...
    def matches_CLIENTS_f58ddf5cee095688aed79a9bb26e21e8(self):
        return re.search(
            self.CLIENTS_f58ddf5cee095688aed79a9bb26e21e8_PATTERN, self.path
        )
    ...
    def matches_CLIENTS_23c141467ea25ec0aa91cbcaff070354(self):
        return re.search(
            self.CLIENTS_23c141467ea25ec0aa91cbcaff070354_PATTERN, self.path
        )
    ...
    def matches_COMMAND_RUNNER_53e946adf864590082fe3111a2a2fa74(self):
        return re.search(
            self.COMMAND_RUNNER_53e946adf864590082fe3111a2a2fa74_PATTERN, self.path
        )
    ...
    def matches_COMMAND_RUNNER_b2dae3b41636596aa02c3ad0a4bcb8d7(self):
        return re.search(
            self.COMMAND_RUNNER_b2dae3b41636596aa02c3ad0a4bcb8d7_PATTERN, self.path
        )
    ...
    def matches_COMPLIANCE_4a1de7ff46fa5da09c5051c06ad07f2c(self):
        return re.search(
            self.COMPLIANCE_4a1de7ff46fa5da09c5051c06ad07f2c_PATTERN, self.path
        )
    ...
    def matches_COMPLIANCE_0802306a0a8d545698d1d59a9be90e51(self):
        return re.search(
            self.COMPLIANCE_0802306a0a8d545698d1d59a9be90e51_PATTERN, self.path
        )
    ...
    def matches_COMPLIANCE_079c37ce8136584f9e2ed471fc896ef9(self):
        return re.search(
            self.COMPLIANCE_079c37ce8136584f9e2ed471fc896ef9_PATTERN, self.path
        )
    ...
    def matches_COMPLIANCE_6395adeaeb8157da972efb7b91e1e2cb(self):
        return re.search(
            self.COMPLIANCE_6395adeaeb8157da972efb7b91e1e2cb_PATTERN, self.path
        )
    ...
    def matches_COMPLIANCE_d3d38fed534f5aeaa80f5a8c63694708(self):
        return re.search(
            self.COMPLIANCE_d3d38fed534f5aeaa80f5a8c63694708_PATTERN, self.path
        )
    ...
    def matches_COMPLIANCE_41da8e5cdd435db0b1da1684be8f15b8(self):
        return re.search(
            self.COMPLIANCE_41da8e5cdd435db0b1da1684be8f15b8_PATTERN, self.path
        )
    ...
    def matches_COMPLIANCE_90b70e1b6a2f51a59690669a4b2fd3f0(self):
        return re.search(
            self.COMPLIANCE_90b70e1b6a2f51a59690669a4b2fd3f0_PATTERN, self.path
        )
                            ...
                            "rollbackTemplateParams": [
                                {
                                    ...
                                    "provider": "string",
                                    "range": [
                                        {"id": "string", "maxValue": 0, "minValue": 0}
                                    ],
                                    "required": True,
                                    "selection": {
                                        "defaultSelectedValues": ["string"],
        ...
        response_content = json.dumps(
            {
                ...
                "deviceInfo": {
                    ...
                    "addnMacAddrs": ["string"],
                    "preWorkflowCliOuputs": [{"cli": "string", "cliOutput": "string"}],
                    "tags": {},
                    "sudiRequired": True,
                ...
                "runSummaryList": [
                    {
                        ...
                        "historyTaskInfo": {
                            ...
                            "timeTaken": 0,
                            "addnDetails": [{"key": "string", "value": "string"}],
                            "name": "string",
                        },
                        "errorFlag": True,
                        "timestamp": 0,
        ...
        response_content = json.dumps(
            {
                ...
                "failureList": [
                    {"index": 0, "serialNum": "string", "id": "string", "msg": "string"}
                ],
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
        ...
        response_content = json.dumps(
            {
                ...
                "ccoUser": "string",
                "syncResult": {
                    "syncList": [{"syncType": "string", "deviceSnList": ["string"]}],
                    "syncMsg": "string",
                },
                "token": "string",
                "syncStartTime": 0,
                ...
                "savaMappingList": [
                    {
                        ...
                        "syncResult": {
                            "syncList": [
                                {"syncType": "string", "deviceSnList": ["string"]}
                            ],
                            "syncMsg": "string",
                        },
                        "lastSync": 0,
    ...
    def matches_DEVICE_REPLACEMENT_e89f8ba4965853b3a075c7401c564477(self):
        return re.search(
            self.DEVICE_REPLACEMENT_e89f8ba4965853b3a075c7401c564477_PATTERN, self.path
        )
    ...
    def matches_DEVICE_REPLACEMENT_2b60f9f312235959812d49dc4c469e83(self):
        return re.search(
            self.DEVICE_REPLACEMENT_2b60f9f312235959812d49dc4c469e83_PATTERN, self.path
        )
    ...
    def matches_DEVICE_REPLACEMENT_ac6e63199fb05bcf89106a22502c2197(self):
        return re.search(
            self.DEVICE_REPLACEMENT_ac6e63199fb05bcf89106a22502c2197_PATTERN, self.path
        )
    ...
    def matches_DEVICE_REPLACEMENT_c2b2882c8fb65284bfc9d781e9ddd07f(self):
        return re.search(
            self.DEVICE_REPLACEMENT_c2b2882c8fb65284bfc9d781e9ddd07f_PATTERN, self.path
        )
    ...
    def matches_DEVICE_REPLACEMENT_19f256e33af7501a8bdae2742ca9f6d6(self):
        return re.search(
            self.DEVICE_REPLACEMENT_19f256e33af7501a8bdae2742ca9f6d6_PATTERN, self.path
        )
    ...
    def matches_DEVICES_30efc372d6eb577ca47e8c86f30c3d2f(self):
        return re.search(
            self.DEVICES_30efc372d6eb577ca47e8c86f30c3d2f_PATTERN, self.path
        )
    ...
    def matches_DEVICES_560c9ee787eb5a0391309f45ddf392ca(self):
        return re.search(
            self.DEVICES_560c9ee787eb5a0391309f45ddf392ca_PATTERN, self.path
        )
    ...
    def matches_DEVICES_08a20c25e0fa518bb186fd7747450ef6(self):
        return re.search(
            self.DEVICES_08a20c25e0fa518bb186fd7747450ef6_PATTERN, self.path
        )
    ...
    def matches_DEVICES_c75e364632e15384a18063458e2ba0e3(self):
        return re.search(
            self.DEVICES_c75e364632e15384a18063458e2ba0e3_PATTERN, self.path
        )
    ...
    def matches_DEVICES_9a570c5ee77b59d8b9cd203e566288e1(self):
        return re.search(
            self.DEVICES_9a570c5ee77b59d8b9cd203e566288e1_PATTERN, self.path
        )
    ...
    def matches_DEVICES_22d3d71136d95562afc211b40004d109(self):
        return re.search(
            self.DEVICES_22d3d71136d95562afc211b40004d109_PATTERN, self.path
        )
    ...
    def matches_DEVICES_0da44fbc3e415a99aac0bdd291e9a87a(self):
        return re.search(
            self.DEVICES_0da44fbc3e415a99aac0bdd291e9a87a_PATTERN, self.path
        )
    ...
    def matches_DEVICES_cf7fa95e3ed4527aa5ba8ca871a8c142(self):
        return re.search(
            self.DEVICES_cf7fa95e3ed4527aa5ba8ca871a8c142_PATTERN, self.path
        )
    ...
    def matches_DEVICES_af71ea437c8755869b00d26ba9234dff(self):
        return re.search(
            self.DEVICES_af71ea437c8755869b00d26ba9234dff_PATTERN, self.path
        )
    ...
    def matches_DEVICES_e057192b97615f0d99a10e2b66bab13a(self):
        return re.search(
            self.DEVICES_e057192b97615f0d99a10e2b66bab13a_PATTERN, self.path
        )
    ...
    def matches_DEVICES_34b7d6c62ea6522081fcf55de7eb9fd7(self):
        return re.search(
            self.DEVICES_34b7d6c62ea6522081fcf55de7eb9fd7_PATTERN, self.path
        )
    ...
    def matches_DEVICES_bef9e9b306085d879b877598fad71b51(self):
        return re.search(
            self.DEVICES_bef9e9b306085d879b877598fad71b51_PATTERN, self.path
        )
    ...
    def matches_DEVICES_5a3d52c630ba5deaada16fe3b07af744(self):
        return re.search(
            self.DEVICES_5a3d52c630ba5deaada16fe3b07af744_PATTERN, self.path
        )
    ...
    def matches_DEVICES_32a2868ff45f5621965f6ece01a742ce(self):
        return re.search(
            self.DEVICES_32a2868ff45f5621965f6ece01a742ce_PATTERN, self.path
        )
    ...
    def matches_DEVICES_17b16bff74ae54ca88a02b34df169218(self):
        return re.search(
            self.DEVICES_17b16bff74ae54ca88a02b34df169218_PATTERN, self.path
        )
    ...
    def matches_DEVICES_2441213b887c55faaca726bbe4ac2564(self):
        return re.search(
            self.DEVICES_2441213b887c55faaca726bbe4ac2564_PATTERN, self.path
        )
    ...
    def matches_DEVICES_fe6d62edcec25921926043ca25f75bed(self):
        return re.search(
            self.DEVICES_fe6d62edcec25921926043ca25f75bed_PATTERN, self.path
        )
    ...
    def matches_DEVICES_399e702d5786552992aa76b930780569(self):
        return re.search(
            self.DEVICES_399e702d5786552992aa76b930780569_PATTERN, self.path
        )
    ...
    def matches_DEVICES_fe602e8165035b5cbc304fada4ee2f26(self):
        return re.search(
            self.DEVICES_fe602e8165035b5cbc304fada4ee2f26_PATTERN, self.path
        )
    ...
    def matches_DEVICES_62704fe3ec7651e79d891fce37a0d860(self):
        return re.search(
            self.DEVICES_62704fe3ec7651e79d891fce37a0d860_PATTERN, self.path
        )
    ...
    def matches_DEVICES_8232fe06867e548bba1919024b40d992(self):
        return re.search(
            self.DEVICES_8232fe06867e548bba1919024b40d992_PATTERN, self.path
        )
    ...
    def matches_DEVICES_b5a5c8da4aaa526da6a06e97c80a38be(self):
        return re.search(
            self.DEVICES_b5a5c8da4aaa526da6a06e97c80a38be_PATTERN, self.path
        )

    def devices_get_device_values_that_match_fully_or_partially_an_attribute_response(
        self,
    ):
        # Add response status code.
        self.send_response(requests.codes.ok)
    ...
    def matches_DEVICES_aa11f09d28165f4ea6c81b8642e59cc4(self):
        return re.search(
            self.DEVICES_aa11f09d28165f4ea6c81b8642e59cc4_PATTERN, self.path
        )
    ...
    def matches_DEVICES_ce94ab18ad505e8a9846f6c4c9df0d2b(self):
        return re.search(
            self.DEVICES_ce94ab18ad505e8a9846f6c4c9df0d2b_PATTERN, self.path
        )
    ...
    def matches_DEVICES_ed2bca4be412527198720a4dfec9604a(self):
        return re.search(
            self.DEVICES_ed2bca4be412527198720a4dfec9604a_PATTERN, self.path
        )
    ...
    def matches_DEVICES_3dc0a72537a3578ca31cc5ef29131d35(self):
        return re.search(
            self.DEVICES_3dc0a72537a3578ca31cc5ef29131d35_PATTERN, self.path
        )
    ...
    def matches_DEVICES_bbfe7340fe6752e5bc273a303d165654(self):
        return re.search(
            self.DEVICES_bbfe7340fe6752e5bc273a303d165654_PATTERN, self.path
        )
    ...
    def matches_DEVICES_57e6ec627d3c587288978990aae75228(self):
        return re.search(
            self.DEVICES_57e6ec627d3c587288978990aae75228_PATTERN, self.path
        )
    ...
    def matches_DEVICES_ad8cea95d71352f0842a2c869765e6cf(self):
        return re.search(
            self.DEVICES_ad8cea95d71352f0842a2c869765e6cf_PATTERN, self.path
        )
    ...
    def matches_DEVICES_7f494532c45654fdaeda8d46a0d9753d(self):
        return re.search(
            self.DEVICES_7f494532c45654fdaeda8d46a0d9753d_PATTERN, self.path
        )
    ...
    def matches_DEVICES_eed1595442b757bf94938c858a257ced(self):
        return re.search(
            self.DEVICES_eed1595442b757bf94938c858a257ced_PATTERN, self.path
        )
    ...
    def matches_DEVICES_bbc074b061d3575d8247084ca33c95d9(self):
        return re.search(
            self.DEVICES_bbc074b061d3575d8247084ca33c95d9_PATTERN, self.path
        )
    ...
    def matches_DEVICES_40123dc74c2052a3a4eb7e2a01eaa8e7(self):
        return re.search(
            self.DEVICES_40123dc74c2052a3a4eb7e2a01eaa8e7_PATTERN, self.path
        )
    ...
    def matches_DEVICES_ce9e547725c45c66824afda98179d12f(self):
        return re.search(
            self.DEVICES_ce9e547725c45c66824afda98179d12f_PATTERN, self.path
        )
    ...
    def matches_DEVICES_fb11f997009751c991884b5fc02087c5(self):
        return re.search(
            self.DEVICES_fb11f997009751c991884b5fc02087c5_PATTERN, self.path
        )
    ...
    def matches_DEVICES_96a4588640da5b018b499c5760f4092a(self):
        return re.search(
            self.DEVICES_96a4588640da5b018b499c5760f4092a_PATTERN, self.path
        )
    ...
    def matches_DEVICES_5c53d56c282e5f108c659009d21f9d26(self):
        return re.search(
            self.DEVICES_5c53d56c282e5f108c659009d21f9d26_PATTERN, self.path
        )
    ...
    def matches_DEVICES_9425f2c120b855cb8c852806ce72e54d(self):
        return re.search(
            self.DEVICES_9425f2c120b855cb8c852806ce72e54d_PATTERN, self.path
        )
    ...
    def matches_DEVICES_8770b2c39feb5e48913492c33add7f13(self):
        return re.search(
            self.DEVICES_8770b2c39feb5e48913492c33add7f13_PATTERN, self.path
        )
    ...
    def matches_DEVICES_d31b0bb4bde55bb8a3078b66c81f3a22(self):
        return re.search(
            self.DEVICES_d31b0bb4bde55bb8a3078b66c81f3a22_PATTERN, self.path
        )
    ...
    def matches_DEVICES_ed266e6eda225aedbf581508635da822(self):
        return re.search(
            self.DEVICES_ed266e6eda225aedbf581508635da822_PATTERN, self.path
        )
    ...
    def matches_DEVICES_119d76a951f85a7a927afc2f1ea935c8(self):
        return re.search(
            self.DEVICES_119d76a951f85a7a927afc2f1ea935c8_PATTERN, self.path
        )
    ...
    def matches_DEVICES_6854f0f19119501094fb5fafe05dfbca(self):
        return re.search(
            self.DEVICES_6854f0f19119501094fb5fafe05dfbca_PATTERN, self.path
        )
    ...
    def matches_DEVICES_4a03cee8dfd7514487a134a422f5e0d7(self):
        return re.search(
            self.DEVICES_4a03cee8dfd7514487a134a422f5e0d7_PATTERN, self.path
        )
    ...
    def matches_DEVICES_c07eaefa1fa45faa801764d9094336ae(self):
        return re.search(
            self.DEVICES_c07eaefa1fa45faa801764d9094336ae_PATTERN, self.path
        )
    ...
    def matches_DEVICES_c1144f7a496455f99f95d36d6474c4b4(self):
        return re.search(
            self.DEVICES_c1144f7a496455f99f95d36d6474c4b4_PATTERN, self.path
        )
    ...
    def matches_DEVICES_a73fbc67627e5bbbafe748de84d42df6(self):
        return re.search(
            self.DEVICES_a73fbc67627e5bbbafe748de84d42df6_PATTERN, self.path
        )
    ...
    def matches_DEVICES_520c1cb24a2b53ce8d29d119c6ee1112(self):
        return re.search(
            self.DEVICES_520c1cb24a2b53ce8d29d119c6ee1112_PATTERN, self.path
        )
    ...
    def matches_DEVICES_ab3215d9be065533b7cbbc978cb4d905(self):
        return re.search(
            self.DEVICES_ab3215d9be065533b7cbbc978cb4d905_PATTERN, self.path
        )
    ...
    def matches_DEVICES_a1878314ffd35d29bea49f12d10b59c8(self):
        return re.search(
            self.DEVICES_a1878314ffd35d29bea49f12d10b59c8_PATTERN, self.path
        )
    ...
    def matches_DEVICES_bd31690b61f45d9f880d74d4e682b070(self):
        return re.search(
            self.DEVICES_bd31690b61f45d9f880d74d4e682b070_PATTERN, self.path
        )
    ...
    def matches_DEVICES_f7a67aba0b365a1e9dae62d148511a25(self):
        return re.search(
            self.DEVICES_f7a67aba0b365a1e9dae62d148511a25_PATTERN, self.path
        )
    ...
    def matches_DEVICES_4500eb13516155a28570e542dcf10a91(self):
        return re.search(
            self.DEVICES_4500eb13516155a28570e542dcf10a91_PATTERN, self.path
        )
    ...
    def matches_DEVICES_358d86f657f8592f97014d2ebf8d37ac(self):
        return re.search(
            self.DEVICES_358d86f657f8592f97014d2ebf8d37ac_PATTERN, self.path
        )
    ...
    def matches_DEVICES_003e01233fa258e393239c4b41882806(self):
        return re.search(
            self.DEVICES_003e01233fa258e393239c4b41882806_PATTERN, self.path
        )
    ...
    def matches_DEVICES_fe0153ca24205608b8741d51f5a6d54a(self):
        return re.search(
            self.DEVICES_fe0153ca24205608b8741d51f5a6d54a_PATTERN, self.path
        )
    ...
    def devices_get_device_summary_response(self):
        ...
        response_content = json.dumps(
            {
                "response": {"id": "string", "role": "string", "roleSource": "string"},
                "version": "string",
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
    ...
    def matches_DEVICES_f90daf1c279351f884ba3198d3b2d641(self):
        return re.search(
            self.DEVICES_f90daf1c279351f884ba3198d3b2d641_PATTERN, self.path
        )
    ...
    def matches_DEVICES_790b4ba6d23d5e7eb62cbba4c9e1a29d(self):
        return re.search(
            self.DEVICES_790b4ba6d23d5e7eb62cbba4c9e1a29d_PATTERN, self.path
        )
    ...
    def matches_DEVICES_fd5fb603cba6523abb25c8ec131fbb8b(self):
        return re.search(
            self.DEVICES_fd5fb603cba6523abb25c8ec131fbb8b_PATTERN, self.path
        )
    ...
    def matches_DEVICES_c01ee650fcf858789ca00c8deda969b9(self):
        return re.search(
            self.DEVICES_c01ee650fcf858789ca00c8deda969b9_PATTERN, self.path
        )
    ...
    def matches_DEVICES_5af0bbf34adb5146b931ec874fc2cc40(self):
        return re.search(
            self.DEVICES_5af0bbf34adb5146b931ec874fc2cc40_PATTERN, self.path
        )
    ...
    def matches_DEVICES_60d7b6ce5abd5dad837e22ace817a6f0(self):
        return re.search(
            self.DEVICES_60d7b6ce5abd5dad837e22ace817a6f0_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_a1d007749a7e5b99aabddf1543714a9a(self):
        return re.search(
            self.DISCOVERY_a1d007749a7e5b99aabddf1543714a9a_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_f325b2c7e429566ba5ed9ae8253b5bef(self):
        return re.search(
            self.DISCOVERY_f325b2c7e429566ba5ed9ae8253b5bef_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_fdbe4ec3e9f252a988404dc94250b80d(self):
        return re.search(
            self.DISCOVERY_fdbe4ec3e9f252a988404dc94250b80d_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_95e37fcf36e3539492dfb9cd21e49620(self):
        return re.search(
            self.DISCOVERY_95e37fcf36e3539492dfb9cd21e49620_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_bde1ca5763fc552ab78cd3b2ecf119b1(self):
        return re.search(
            self.DISCOVERY_bde1ca5763fc552ab78cd3b2ecf119b1_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_1bb187b0c0a55e7e8089ac78eb29d8a2(self):
        return re.search(
            self.DISCOVERY_1bb187b0c0a55e7e8089ac78eb29d8a2_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_c4370f0a57d85355a7061d7671f1b613(self):
        return re.search(
            self.DISCOVERY_c4370f0a57d85355a7061d7671f1b613_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_e369e19c1a835567855984d9f2c628ef(self):
        return re.search(
            self.DISCOVERY_e369e19c1a835567855984d9f2c628ef_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_f478b876b38a5cf094d80eced531b1a0(self):
        return re.search(
            self.DISCOVERY_f478b876b38a5cf094d80eced531b1a0_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_a2f0cb47996d5bf7a3d5de89e2a002bb(self):
        return re.search(
            self.DISCOVERY_a2f0cb47996d5bf7a3d5de89e2a002bb_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_7fd0ae0041dc59fb8aae545a8199d7b4(self):
        return re.search(
            self.DISCOVERY_7fd0ae0041dc59fb8aae545a8199d7b4_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_98155b212632561f886c01676b12a2b1(self):
        return re.search(
            self.DISCOVERY_98155b212632561f886c01676b12a2b1_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_6cba543cfb0957e9bc38d8c7f49f3e47(self):
        return re.search(
            self.DISCOVERY_6cba543cfb0957e9bc38d8c7f49f3e47_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_e847420499a7592d993b7c7dff809f0d(self):
        return re.search(
            self.DISCOVERY_e847420499a7592d993b7c7dff809f0d_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_3ce4a30581da554591309dd423a91e7a(self):
        return re.search(
            self.DISCOVERY_3ce4a30581da554591309dd423a91e7a_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_678669d39d23589e85db0a63c414057c(self):
        return re.search(
            self.DISCOVERY_678669d39d23589e85db0a63c414057c_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_c524f0ec199e5435bcaee56b423532e7(self):
        return re.search(
            self.DISCOVERY_c524f0ec199e5435bcaee56b423532e7_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_1ffcaccdd9f2530abf66adc98c3f0201(self):
        return re.search(
            self.DISCOVERY_1ffcaccdd9f2530abf66adc98c3f0201_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_1d1845268faf55f98bc952872259f16f(self):
        return re.search(
            self.DISCOVERY_1d1845268faf55f98bc952872259f16f_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_6f6536a8f01d5863856a0a8308198e15(self):
        return re.search(
            self.DISCOVERY_6f6536a8f01d5863856a0a8308198e15_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_1f77386a48895fa59dcddcc7dd4addb5(self):
        return re.search(
            self.DISCOVERY_1f77386a48895fa59dcddcc7dd4addb5_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_702f7cf4f24d54c6944a31ed308f8361(self):
        return re.search(
            self.DISCOVERY_702f7cf4f24d54c6944a31ed308f8361_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_7f5645e6e819558fa08761dee45ca406(self):
        return re.search(
            self.DISCOVERY_7f5645e6e819558fa08761dee45ca406_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_e3d7ad943d3a50fb8c3be7327669e557(self):
        return re.search(
            self.DISCOVERY_e3d7ad943d3a50fb8c3be7327669e557_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_8d16471a58805b4aa2c757209d188aed(self):
        return re.search(
            self.DISCOVERY_8d16471a58805b4aa2c757209d188aed_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_2a3a1bf404bf5772828f66f1e10f074d(self):
        return re.search(
            self.DISCOVERY_2a3a1bf404bf5772828f66f1e10f074d_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_92179760c9ea5c02b2b7368cac785f30(self):
        return re.search(
            self.DISCOVERY_92179760c9ea5c02b2b7368cac785f30_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_2782bdc981805b5fad0a038966d52558(self):
        return re.search(
            self.DISCOVERY_2782bdc981805b5fad0a038966d52558_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_ecdb2d14c29b5bf3ad79ed2e3cc70715(self):
        return re.search(
            self.DISCOVERY_ecdb2d14c29b5bf3ad79ed2e3cc70715_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_a82cc61ddeae50969464f7b5d7d6bbf1(self):
        return re.search(
            self.DISCOVERY_a82cc61ddeae50969464f7b5d7d6bbf1_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_4f5d13316c8f53a0b78d881c738a15c6(self):
        return re.search(
            self.DISCOVERY_4f5d13316c8f53a0b78d881c738a15c6_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_659a37de9e4e5fab8c65b0701b074fd2(self):
        return re.search(
            self.DISCOVERY_659a37de9e4e5fab8c65b0701b074fd2_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_9031dfb02d27503fab05602db7311e90(self):
        return re.search(
            self.DISCOVERY_9031dfb02d27503fab05602db7311e90_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_da593242978c5047bb6b62b7f9475326(self):
        return re.search(
            self.DISCOVERY_da593242978c5047bb6b62b7f9475326_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_1b3323a24b275402b97c7e9ccfd78c91(self):
        return re.search(
            self.DISCOVERY_1b3323a24b275402b97c7e9ccfd78c91_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_3573d2ece28b509b8ef80b2b8c5c5f36(self):
        return re.search(
            self.DISCOVERY_3573d2ece28b509b8ef80b2b8c5c5f36_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_8a473a278a325c67abd310df49bae1bb(self):
        return re.search(
            self.DISCOVERY_8a473a278a325c67abd310df49bae1bb_PATTERN, self.path
        )
    ...
    def matches_DISCOVERY_caa7cd8d7a3550cfb102cd3498494d04(self):
        return re.search(
            self.DISCOVERY_caa7cd8d7a3550cfb102cd3498494d04_PATTERN, self.path
        )
    ...
    def matches_EO_X_64d5d27a53ac53258fa2183b7e93a7d5(self):
        return re.search(self.EO_X_64d5d27a53ac53258fa2183b7e93a7d5_PATTERN, self.path)
    ...
    def matches_EO_X_816ec048832853f8a63f34415d0e6fce(self):
        return re.search(self.EO_X_816ec048832853f8a63f34415d0e6fce_PATTERN, self.path)
    ...
    def matches_EO_X_f0a0dfdaca465bdc91fc290d87476b89(self):
        return re.search(self.EO_X_f0a0dfdaca465bdc91fc290d87476b89_PATTERN, self.path)
    ...
    def matches_EVENT_MANAGEMENT_9f8e3a0674c15fd58cd78f42dca37c7c(self):
        return re.search(
            self.EVENT_MANAGEMENT_9f8e3a0674c15fd58cd78f42dca37c7c_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_894ea7c0220d55ae9e1a51d6823ce862(self):
        return re.search(
            self.EVENT_MANAGEMENT_894ea7c0220d55ae9e1a51d6823ce862_PATTERN, self.path
        )
    ...
    def event_management_get_auditlog_summary_response(self):
        ...
        # Add response content.
        response_content = json.dumps(
            [{"count": 0, "maxTimestamp": 0, "minTimestamp": 0}]
        )
        self.wfile.write(response_content.encode("utf-8"))
        return
    ...
    def matches_EVENT_MANAGEMENT_b0aa5a61f64a5da997dfe05bc8a4a64f(self):
        return re.search(
            self.EVENT_MANAGEMENT_b0aa5a61f64a5da997dfe05bc8a4a64f_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_e1bd67a1a0225713ab23f0d0d3ceb4f6(self):
        return re.search(
            self.EVENT_MANAGEMENT_e1bd67a1a0225713ab23f0d0d3ceb4f6_PATTERN, self.path
        )
    ...
    def event_management_get_status_api_for_events_response(self):
        ...
        # Add response content.
        response_content = json.dumps(
            {"errorMessage": {}, "apiStatus": "string", "statusMessage": "string"}
        )
        self.wfile.write(response_content.encode("utf-8"))
        return
    ...
    def matches_EVENT_MANAGEMENT_96aaebb912125213b350d7423b4f01a4(self):
        return re.search(
            self.EVENT_MANAGEMENT_96aaebb912125213b350d7423b4f01a4_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_d5f08e8ff59e51d1a9ae56c3e20eae3c(self):
        return re.search(
            self.EVENT_MANAGEMENT_d5f08e8ff59e51d1a9ae56c3e20eae3c_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_9c991ce0b0f058a08c863a4abdfc70a6(self):
        return re.search(
            self.EVENT_MANAGEMENT_9c991ce0b0f058a08c863a4abdfc70a6_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_c641f481dd285301861010da8d6fbf9f(self):
        return re.search(
            self.EVENT_MANAGEMENT_c641f481dd285301861010da8d6fbf9f_PATTERN, self.path
        )
            ...
            [
                {
                    ...
                    "details": "string",
                    "eventHierarchy": "string",
                    "network": {"siteId": "string", "deviceId": "string"},
                }
            ]
        )
        self.wfile.write(response_content.encode("utf-8"))
    ...
    def matches_EVENT_MANAGEMENT_4431fd269fe156e4b5ad3f4210b7b168(self):
        return re.search(
            self.EVENT_MANAGEMENT_4431fd269fe156e4b5ad3f4210b7b168_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_6e698d5a990a55158003a9f3250316a8(self):
        return re.search(
            self.EVENT_MANAGEMENT_6e698d5a990a55158003a9f3250316a8_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_343538d7d4e55d6bbb21c34ce863a131(self):
        return re.search(
            self.EVENT_MANAGEMENT_343538d7d4e55d6bbb21c34ce863a131_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_a0e0b1772dfc5a02a96a9f6ee6e2579b(self):
        return re.search(
            self.EVENT_MANAGEMENT_a0e0b1772dfc5a02a96a9f6ee6e2579b_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_dfda5beca4cc5437876bff366493ebf0(self):
        return re.search(
            self.EVENT_MANAGEMENT_dfda5beca4cc5437876bff366493ebf0_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_5fcc151af7615a84adf48b714d146192(self):
        return re.search(
            self.EVENT_MANAGEMENT_5fcc151af7615a84adf48b714d146192_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_403889d420225889bb16f99ec7ba099a(self):
        return re.search(
            self.EVENT_MANAGEMENT_403889d420225889bb16f99ec7ba099a_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_86272f278c72555e9a56f554b2a21c85(self):
        return re.search(
            self.EVENT_MANAGEMENT_86272f278c72555e9a56f554b2a21c85_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_c0dcb335458a58fa8bc5a485b174427d(self):
        return re.search(
            self.EVENT_MANAGEMENT_c0dcb335458a58fa8bc5a485b174427d_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_c538dc50a4555b5fba17b672a89ee1b8(self):
        return re.search(
            self.EVENT_MANAGEMENT_c538dc50a4555b5fba17b672a89ee1b8_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_2e69d02d71905aecbd10b782469efbda(self):
        return re.search(
            self.EVENT_MANAGEMENT_2e69d02d71905aecbd10b782469efbda_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_f8b4842604b65658afb34b4f124db469(self):
        return re.search(
            self.EVENT_MANAGEMENT_f8b4842604b65658afb34b4f124db469_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_bc212b5ee1f252479f35e8dd58319f17(self):
        return re.search(
            self.EVENT_MANAGEMENT_bc212b5ee1f252479f35e8dd58319f17_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_9f41eb48a0da56949cfaddeecb51ab66(self):
        return re.search(
            self.EVENT_MANAGEMENT_9f41eb48a0da56949cfaddeecb51ab66_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_1ee2008494d158e7bff7f106519a64c5(self):
        return re.search(
            self.EVENT_MANAGEMENT_1ee2008494d158e7bff7f106519a64c5_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_7474456b6581534bb321eaea272365b7(self):
        return re.search(
            self.EVENT_MANAGEMENT_7474456b6581534bb321eaea272365b7_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_8d8fc92ddeab597ebb50ea003a6d46bd(self):
        return re.search(
            self.EVENT_MANAGEMENT_8d8fc92ddeab597ebb50ea003a6d46bd_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_99fb5a8c0075563491622171958074bf(self):
        return re.search(
            self.EVENT_MANAGEMENT_99fb5a8c0075563491622171958074bf_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_c7bed4b4148753e6bc9912e3be135217(self):
        return re.search(
            self.EVENT_MANAGEMENT_c7bed4b4148753e6bc9912e3be135217_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_6a9f5796226051218eac559ab5211384(self):
        return re.search(
            self.EVENT_MANAGEMENT_6a9f5796226051218eac559ab5211384_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_a170168de2ac55cc93571af1fbc02894(self):
        return re.search(
            self.EVENT_MANAGEMENT_a170168de2ac55cc93571af1fbc02894_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_919dece7a9b353b49084a8ffa4f18c91(self):
        return re.search(
            self.EVENT_MANAGEMENT_919dece7a9b353b49084a8ffa4f18c91_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_36b8699619f95a24bd2d81f12f048235(self):
        return re.search(
            self.EVENT_MANAGEMENT_36b8699619f95a24bd2d81f12f048235_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_d5c229546dc755f796dfcf34f1c2e290(self):
        return re.search(
            self.EVENT_MANAGEMENT_d5c229546dc755f796dfcf34f1c2e290_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_ddecdd64b34c5fdc910296fce09b2828(self):
        return re.search(
            self.EVENT_MANAGEMENT_ddecdd64b34c5fdc910296fce09b2828_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_bf36f1819e61575189c0709efab6e48a(self):
        return re.search(
            self.EVENT_MANAGEMENT_bf36f1819e61575189c0709efab6e48a_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_3b21d2947d715c198f5e62ba3149839a(self):
        return re.search(
            self.EVENT_MANAGEMENT_3b21d2947d715c198f5e62ba3149839a_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_584c0e0d76b2561b8f2efd0220f02267(self):
        return re.search(
            self.EVENT_MANAGEMENT_584c0e0d76b2561b8f2efd0220f02267_PATTERN, self.path
        )
            ...
            [
                {
                    ...
                    "eventPayload": {
                        ...
                        "source": "string",
                        "severity": "string",
                        "details": {"device_ip": "string", "message": "string"},
                        "additionalDetails": {},
                    },
                    "eventTemplates": [{}],
                    "isTenantAware": True,
    ...
    def matches_EVENT_MANAGEMENT_a137e0b583c85ffe80fbbd85b480bf15(self):
        return re.search(
            self.EVENT_MANAGEMENT_a137e0b583c85ffe80fbbd85b480bf15_PATTERN, self.path
        )
    ...
    def matches_EVENT_MANAGEMENT_632352b94cfb5af084c1a65d8e51df71(self):
        return re.search(
            self.EVENT_MANAGEMENT_632352b94cfb5af084c1a65d8e51df71_PATTERN, self.path
        )
    ...
    def matches_FABRIC_WIRELESS_ad96e712f4525a128368b1bfe3afc21c(self):
        return re.search(
            self.FABRIC_WIRELESS_ad96e712f4525a128368b1bfe3afc21c_PATTERN, self.path
        )
    ...
    def matches_FABRIC_WIRELESS_249809f90ae8599c8a21c98b7a1ca804(self):
        return re.search(
            self.FABRIC_WIRELESS_249809f90ae8599c8a21c98b7a1ca804_PATTERN, self.path
        )
    ...
    def matches_FABRIC_WIRELESS_2b0f6a0410705c75a61cdc51cc96c53f(self):
        return re.search(
            self.FABRIC_WIRELESS_2b0f6a0410705c75a61cdc51cc96c53f_PATTERN, self.path
        )
    ...
    def fabric_wireless_get_ssid_to_ip_pool_mapping_response(self):
        ...
        response_content = json.dumps(
            {
                "vlanName": "string",
                "ssidDetails": [{"name": "string", "scalableGroupName": "string"}],
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
        return
    ...
    def matches_FABRIC_WIRELESS_76039bb706025a9cb183ce7a60e0b5df(self):
        return re.search(
            self.FABRIC_WIRELESS_76039bb706025a9cb183ce7a60e0b5df_PATTERN, self.path
        )
    ...
    def matches_FABRIC_WIRELESS_6c4befbd77a452a9b7873ffc360a1f20(self):
        return re.search(
            self.FABRIC_WIRELESS_6c4befbd77a452a9b7873ffc360a1f20_PATTERN, self.path
        )
    ...
    def matches_FILE_b7fc125c901c5d4488b7a2b75fa292bc(self):
        return re.search(self.FILE_b7fc125c901c5d4488b7a2b75fa292bc_PATTERN, self.path)
    ...
    def matches_FILE_b7d63a5ae65b59a5a35d43edc58b6db5(self):
        return re.search(self.FILE_b7d63a5ae65b59a5a35d43edc58b6db5_PATTERN, self.path)
    ...
    def matches_FILE_1282fa4ab7605a75aafa6c7da6ac3f13(self):
        return re.search(self.FILE_1282fa4ab7605a75aafa6c7da6ac3f13_PATTERN, self.path)
    ...
    def matches_FILE_3113e7fb3df05906b8cd6077d4d9cc5c(self):
        return re.search(self.FILE_3113e7fb3df05906b8cd6077d4d9cc5c_PATTERN, self.path)
        ...
        response_content = json.dumps(
            {
                ...
                "version": "string",
                "kpis": {
                    "cpu": {"units": "string", "utilization": "string"},
                    "memory": {"units": "string", "utilization": "string"},
                    "network tx_rate": {"units": "string", "utilization": "string"},
                    "network rx_rate": {"units": "string", "utilization": "string"},
                },
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
        ...
        response_content = json.dumps(
            {
                ...
                "kpis": {
                    "legends": {
                        "cpu": {"units": "string"},
                        "memory": {"units": "string"},
                        "network tx_rate": {"units": "string"},
                        "network rx_rate": {"units": "string"},
                    },
                    "data": {"t1": ["string"]},
                },
            }
    ...
    def matches_ITSM_46eb1bf346225a4ba24f18408ffca7c9(self):
        return re.search(self.ITSM_46eb1bf346225a4ba24f18408ffca7c9_PATTERN, self.path)
    ...
    def matches_ITSM_da70082b298a5a908edb780a61bd4ca6(self):
        return re.search(self.ITSM_da70082b298a5a908edb780a61bd4ca6_PATTERN, self.path)
    ...
    def matches_ITSM_25624cfb1d6e52878d057740de275896(self):
        return re.search(self.ITSM_25624cfb1d6e52878d057740de275896_PATTERN, self.path)
    ...
    def matches_ITSM_INTEGRATION_2bb01b6bd31b53bfb12bbe327320392e(self):
        return re.search(
            self.ITSM_INTEGRATION_2bb01b6bd31b53bfb12bbe327320392e_PATTERN, self.path
        )
    ...
    def matches_ITSM_INTEGRATION_c9b5b83e67195b649077a05e42897cc4(self):
        return re.search(
            self.ITSM_INTEGRATION_c9b5b83e67195b649077a05e42897cc4_PATTERN, self.path
        )
    ...
    def matches_ITSM_INTEGRATION_53ca7a97d4665bca9634b6fb41cd7d29(self):
        return re.search(
            self.ITSM_INTEGRATION_53ca7a97d4665bca9634b6fb41cd7d29_PATTERN, self.path
        )
    ...
    def matches_ITSM_INTEGRATION_7ae71ae83f7f530c81e650c1455567e8(self):
        return re.search(
            self.ITSM_INTEGRATION_7ae71ae83f7f530c81e650c1455567e8_PATTERN, self.path
        )
    ...
    def matches_ITSM_INTEGRATION_ac54638bea4157f2bbd03f329ac25e27(self):
        return re.search(
            self.ITSM_INTEGRATION_ac54638bea4157f2bbd03f329ac25e27_PATTERN, self.path
        )
    ...
    def matches_ISSUES_915745bc55e6552fac58cc0aaacd773a(self):
        return re.search(
            self.ISSUES_915745bc55e6552fac58cc0aaacd773a_PATTERN, self.path
        )
    ...
    def matches_ISSUES_02f2f039811951c0af53e3381ae91225(self):
        return re.search(
            self.ISSUES_02f2f039811951c0af53e3381ae91225_PATTERN, self.path
        )
                    ...
                    "issue": [
                        {
                            ...
                            "issueSummary": "string",
                            "issueTimestamp": 0,
                            "suggestedActions": [{"message": "string", "steps": [{}]}],
                            "impactedHosts": [{}],
                        }
                    ]
                }
    ...
    def matches_ISSUES_759522aaef3b519ba8b9fb2cbf43b985(self):
        return re.search(
            self.ISSUES_759522aaef3b519ba8b9fb2cbf43b985_PATTERN, self.path
        )
    ...
    def matches_LAN_AUTOMATION_b119a4d455e35cc3b2cc6695a045cbfa(self):
        return re.search(
            self.LAN_AUTOMATION_b119a4d455e35cc3b2cc6695a045cbfa_PATTERN, self.path
        )
    ...
    def lan_automation_lan_automation_start_response(self):
        ...
        # Add response content.
        response_content = json.dumps(
            {"response": {"message": "string", "id": "string"}, "version": "string"}
        )
        self.wfile.write(response_content.encode("utf-8"))
        return
    ...
    def matches_LAN_AUTOMATION_130eea014edd5807925df3a414a92ed4(self):
        return re.search(
            self.LAN_AUTOMATION_130eea014edd5807925df3a414a92ed4_PATTERN, self.path
        )
    ...
    def matches_LAN_AUTOMATION_3173e37f6c9650b68e0aaac866a162cf(self):
        return re.search(
            self.LAN_AUTOMATION_3173e37f6c9650b68e0aaac866a162cf_PATTERN, self.path
        )
    ...
    def matches_LAN_AUTOMATION_60e98b744fde50a1b53761251c43bfb0(self):
        return re.search(
            self.LAN_AUTOMATION_60e98b744fde50a1b53761251c43bfb0_PATTERN, self.path
        )
    ...
    def matches_LAN_AUTOMATION_26485c3441f7507a98d02579c25814f4(self):
        return re.search(
            self.LAN_AUTOMATION_26485c3441f7507a98d02579c25814f4_PATTERN, self.path
        )
    ...
    def matches_LAN_AUTOMATION_5a19cf2241e75c648220d7172e9e4013(self):
        return re.search(
            self.LAN_AUTOMATION_5a19cf2241e75c648220d7172e9e4013_PATTERN, self.path
        )
    ...
    def matches_LAN_AUTOMATION_40c56a6c58fd5b71b7949036855ee25b(self):
        return re.search(
            self.LAN_AUTOMATION_40c56a6c58fd5b71b7949036855ee25b_PATTERN, self.path
        )
                ...
                "response": [
                    {
                        ...
                        "ipPoolList": [
                            {"ipPoolName": "string", "ipPoolRole": "string"}
                        ],
                        "primaryDeviceInterfaceNames": ["string"],
                        "status": "string",
                        "action": "string",
                        "creationTime": "string",
    ...
    def matches_LAN_AUTOMATION_d5727c4bdb1056308cd10e99dff2acb8(self):
        return re.search(
            self.LAN_AUTOMATION_d5727c4bdb1056308cd10e99dff2acb8_PATTERN, self.path
        )
    ...
    def matches_LAN_AUTOMATION_ed815ca3e5ab5ae48720795217ec776b(self):
        return re.search(
            self.LAN_AUTOMATION_ed815ca3e5ab5ae48720795217ec776b_PATTERN, self.path
        )
    ...
    def matches_LICENSES_87c0cf04bdc758b29bb11abbdacbd921(self):
        return re.search(
            self.LICENSES_87c0cf04bdc758b29bb11abbdacbd921_PATTERN, self.path
        )

    def licenses_device_count_details2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header("Content-Type", "application/json; charset=utf-8")
    ...
    def matches_LICENSES_f4ba64eef4085d518a612835e128fe3c(self):
        return re.search(
            self.LICENSES_f4ba64eef4085d518a612835e128fe3c_PATTERN, self.path
        )

    def licenses_device_license_summary2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header("Content-Type", "application/json; charset=utf-8")
    ...
    def matches_LICENSES_6f04f865c01d5c17a5f0cb5abe620dd8(self):
        return re.search(
            self.LICENSES_6f04f865c01d5c17a5f0cb5abe620dd8_PATTERN, self.path
        )

    def licenses_device_license_details2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header("Content-Type", "application/json; charset=utf-8")
                ...
                "response": [
                    {
                        ...
                        "access_points": [{"ap_type": "string", "count": "string"}],
                        "chassis_details": {
    ...
    def matches_LICENSES_0109b2f15d0c54c2862a60a904289ddd(self):
        return re.search(
            self.LICENSES_0109b2f15d0c54c2862a60a904289ddd_PATTERN, self.path
        )

    def licenses_device_deregistration2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header("Content-Type", "application/json; charset=utf-8")
        ...
        # Add response content.
        response_content = json.dumps(
            {"response": {"taskId": "string", "url": "string"}}
        )
        self.wfile.write(response_content.encode("utf-8"))
        return
    ...
    def matches_LICENSES_df26f516755a50b5b5477324cf5cb649(self):
        return re.search(
            self.LICENSES_df26f516755a50b5b5477324cf5cb649_PATTERN, self.path
        )

    def licenses_device_registration2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header("Content-Type", "application/json; charset=utf-8")
    ...
    def matches_LICENSES_4bd5b507f58a50aab614e3d7409eec4c(self):
        return re.search(
            self.LICENSES_4bd5b507f58a50aab614e3d7409eec4c_PATTERN, self.path
        )

    def licenses_change_virtual_account2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header("Content-Type", "application/json; charset=utf-8")
    ...
    def matches_LICENSES_8ab450b197375fa9bcd95219113a3075(self):
        return re.search(
            self.LICENSES_8ab450b197375fa9bcd95219113a3075_PATTERN, self.path
        )

    def licenses_virtual_account_details2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header("Content-Type", "application/json; charset=utf-8")
        ...
        response_content = json.dumps(
            {
                ...
                "virtual_account_details": [
                    {"virtual_account_id": "string", "virtual_account_name": "string"}
                ],
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
    ...
    def matches_LICENSES_ea3fdbde23325051a76b9d062c2962a0(self):
        return re.search(
            self.LICENSES_ea3fdbde23325051a76b9d062c2962a0_PATTERN, self.path
        )
    ...
    def matches_LICENSES_df2d278e89b45c8ea0ca0a945c001f08(self):
        return re.search(
            self.LICENSES_df2d278e89b45c8ea0ca0a945c001f08_PATTERN, self.path
        )

    def licenses_license_term_details2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header("Content-Type", "application/json; charset=utf-8")
    ...
    def matches_LICENSES_46e55ecbbda454c6a01d905e6f4cce16(self):
        return re.search(
            self.LICENSES_46e55ecbbda454c6a01d905e6f4cce16_PATTERN, self.path
        )

    def licenses_license_usage_details2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header("Content-Type", "application/json; charset=utf-8")
        ...
        response_content = json.dumps(
            {
                "purchased_dna_license": {
                    ...
                    "license_count_by_type": [
                        {"license_type": "string", "license_count": 0}
                    ],
                },
    ...
    def matches_NETWORK_SETTINGS_4e4f91ea42515ccdbc24549b84ca1e90(self):
        return re.search(
            self.NETWORK_SETTINGS_4e4f91ea42515ccdbc24549b84ca1e90_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_903cf2cac6f150c9bee9ade37921b162(self):
        return re.search(
            self.NETWORK_SETTINGS_903cf2cac6f150c9bee9ade37921b162_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_722d7161b33157dba957ba18eda440c2(self):
        return re.search(
            self.NETWORK_SETTINGS_722d7161b33157dba957ba18eda440c2_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_403067d8cf995d9d99bdc31707817456(self):
        return re.search(
            self.NETWORK_SETTINGS_403067d8cf995d9d99bdc31707817456_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_598e8e021f1c51eeaf0d102084481486(self):
        return re.search(
            self.NETWORK_SETTINGS_598e8e021f1c51eeaf0d102084481486_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_ebdcd84fc41754a69eaeacf7c0b0731c(self):
        return re.search(
            self.NETWORK_SETTINGS_ebdcd84fc41754a69eaeacf7c0b0731c_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_5c380301e3e05423bdc1857ff00ae77a(self):
        return re.search(
            self.NETWORK_SETTINGS_5c380301e3e05423bdc1857ff00ae77a_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_eecf4323cb285985be72a7e061891059(self):
        return re.search(
            self.NETWORK_SETTINGS_eecf4323cb285985be72a7e061891059_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_61f9079863c95acd945c51f728cbf81f(self):
        return re.search(
            self.NETWORK_SETTINGS_61f9079863c95acd945c51f728cbf81f_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_40397b199c175281977a7e9e6bd9255b(self):
        return re.search(
            self.NETWORK_SETTINGS_40397b199c175281977a7e9e6bd9255b_PATTERN, self.path
        )
                ...
                "response": [
                    {
                        ...
                        "key": "string",
                        "version": 0,
                        "value": [{"ipAddresses": ["string"], "configureDnacIP": True}],
                        "groupUuid": "string",
    ...
    def matches_NETWORK_SETTINGS_6eca62ef076b5627a85b2a5959613fb8(self):
        return re.search(
            self.NETWORK_SETTINGS_6eca62ef076b5627a85b2a5959613fb8_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_e1b8c435195d56368c24a54dcce007d0(self):
        return re.search(
            self.NETWORK_SETTINGS_e1b8c435195d56368c24a54dcce007d0_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_274851d84253559e9d3e81881a4bd2fc(self):
        return re.search(
            self.NETWORK_SETTINGS_274851d84253559e9d3e81881a4bd2fc_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_eabbb425255a57578e9db00cda1f303a(self):
        return re.search(
            self.NETWORK_SETTINGS_eabbb425255a57578e9db00cda1f303a_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_700808cec6c85d9bb4bcc8f61f31296b(self):
        return re.search(
            self.NETWORK_SETTINGS_700808cec6c85d9bb4bcc8f61f31296b_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_07fd6083b0c65d03b2d53f10b3ece59d(self):
        return re.search(
            self.NETWORK_SETTINGS_07fd6083b0c65d03b2d53f10b3ece59d_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_69dda850a0675b888048adf8d488aec1(self):
        return re.search(
            self.NETWORK_SETTINGS_69dda850a0675b888048adf8d488aec1_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_1ffa347eb411567a9c793696795250a5(self):
        return re.search(
            self.NETWORK_SETTINGS_1ffa347eb411567a9c793696795250a5_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_03e22c99a82f5764828810acb45e7a9e(self):
        return re.search(
            self.NETWORK_SETTINGS_03e22c99a82f5764828810acb45e7a9e_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_35598a1d68f15e02adc37239b3fcbbb6(self):
        return re.search(
            self.NETWORK_SETTINGS_35598a1d68f15e02adc37239b3fcbbb6_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_156a3954b27e5eeb82789ed231e0557f(self):
        return re.search(
            self.NETWORK_SETTINGS_156a3954b27e5eeb82789ed231e0557f_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_d0b7bffe821755dab4e2a2df8ea79404(self):
        return re.search(
            self.NETWORK_SETTINGS_d0b7bffe821755dab4e2a2df8ea79404_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_c5f97865727857d5b1eeaedee3dcccd2(self):
        return re.search(
            self.NETWORK_SETTINGS_c5f97865727857d5b1eeaedee3dcccd2_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_a7935eedd53a5b8c84668c903cc1c705(self):
        return re.search(
            self.NETWORK_SETTINGS_a7935eedd53a5b8c84668c903cc1c705_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_a66db26df529597c84c2a15ea2d632ce(self):
        return re.search(
            self.NETWORK_SETTINGS_a66db26df529597c84c2a15ea2d632ce_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_53680237e0b654c39dc6e19cd6f5194d(self):
        return re.search(
            self.NETWORK_SETTINGS_53680237e0b654c39dc6e19cd6f5194d_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_3907f01025635a52bdfdac7226911b31(self):
        return re.search(
            self.NETWORK_SETTINGS_3907f01025635a52bdfdac7226911b31_PATTERN, self.path
        )
    ...
    def matches_NETWORK_SETTINGS_a9bbbce953615baeb0a324c61753139d(self):
        return re.search(
            self.NETWORK_SETTINGS_a9bbbce953615baeb0a324c61753139d_PATTERN, self.path
        )
    ...
    def matches_PATH_TRACE_a75e4b27171c5c6782e84f902da9e5be(self):
        return re.search(
            self.PATH_TRACE_a75e4b27171c5c6782e84f902da9e5be_PATTERN, self.path
        )
    ...
    def matches_PATH_TRACE_a54fce1a0c305bdabfe91a8a6161e539(self):
        return re.search(
            self.PATH_TRACE_a54fce1a0c305bdabfe91a8a6161e539_PATTERN, self.path
        )
    ...
    def matches_PATH_TRACE_ed5cbafc332a5efa97547736ba8b6044(self):
        return re.search(
            self.PATH_TRACE_ed5cbafc332a5efa97547736ba8b6044_PATTERN, self.path
        )
        ...
        response_content = json.dumps(
            {
                "response": {
                    ...
                    "networkElements": [
                        {
                            "accuracyList": [{"percent": 0, "reason": "string"}],
                            "detailedStatus": {
                                "aclTraceCalculation": "string",
                                "aclTraceCalculationFailureReason": "string",
                            },
    ...
    def matches_PATH_TRACE_8a7ae984f943507ba621abe155e6e744(self):
        return re.search(
            self.PATH_TRACE_8a7ae984f943507ba621abe155e6e744_PATTERN, self.path
        )
    ...
    def matches_PLATFORM_0c3bdcd996dd5d988d0d77ce8f732014(self):
        return re.search(
            self.PLATFORM_0c3bdcd996dd5d988d0d77ce8f732014_PATTERN, self.path
        )
    ...
    def platform_cisco_dna_center_packages_summary_response(self):
        ...
        # Add response content.
        response_content = json.dumps(
            {"response": [{"name": "string", "version": "string"}], "version": "string"}
        )
        self.wfile.write(response_content.encode("utf-8"))
        return
    ...
    def matches_PLATFORM_63206c9b144b5dc2ba26e51798f8bede(self):
        return re.search(
            self.PLATFORM_63206c9b144b5dc2ba26e51798f8bede_PATTERN, self.path
        )
    ...
    def matches_PLATFORM_0f0c26c266e552d6b0f1f68da8e60e16(self):
        return re.search(
            self.PLATFORM_0f0c26c266e552d6b0f1f68da8e60e16_PATTERN, self.path
        )
                            ...
                            "network": [
                                {
                                    ...
                                    "interface": "string",
                                    "inet6": {"host_ip": "string", "netmask": "string"},
                                    "lacp_supported": True,
                                    "slave": ["string"],
                                }
                            ],
    ...
    def matches_REPORTS_220fa310ab095148bdb00d7d3d5e1676(self):
        return re.search(
            self.REPORTS_220fa310ab095148bdb00d7d3d5e1676_PATTERN, self.path
        )
    ...
    def matches_REPORTS_095d89e1c3e150ef9faaff44fa483de5(self):
        return re.search(
            self.REPORTS_095d89e1c3e150ef9faaff44fa483de5_PATTERN, self.path
        )
    ...
    def matches_REPORTS_76f9cb7c424b5502b4ad54ccbb1ca4f4(self):
        return re.search(
            self.REPORTS_76f9cb7c424b5502b4ad54ccbb1ca4f4_PATTERN, self.path
        )
    ...
    def matches_REPORTS_8a6a151b68d450dfaf1e8a92e0f5cc68(self):
        return re.search(
            self.REPORTS_8a6a151b68d450dfaf1e8a92e0f5cc68_PATTERN, self.path
        )
    ...
    def matches_REPORTS_a4b1ca0320185570bc12da238f0e88bb(self):
        return re.search(
            self.REPORTS_a4b1ca0320185570bc12da238f0e88bb_PATTERN, self.path
        )
    ...
    def matches_REPORTS_2921b2790cdb5abf98c8e00011de86a4(self):
        return re.search(
            self.REPORTS_2921b2790cdb5abf98c8e00011de86a4_PATTERN, self.path
        )
    ...
    def matches_REPORTS_bbff833d5d5756698f4764a9d488cc98(self):
        return re.search(
            self.REPORTS_bbff833d5d5756698f4764a9d488cc98_PATTERN, self.path
        )
    ...
    def matches_REPORTS_c5879612ddc05cd0a0de09d29da4907e(self):
        return re.search(
            self.REPORTS_c5879612ddc05cd0a0de09d29da4907e_PATTERN, self.path
        )
        ...
        response_content = json.dumps(
            {
                "viewGroupId": "string",
                "views": [
                    {"description": "string", "viewId": "string", "viewName": "string"}
                ],
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
    ...
    def matches_REPORTS_3d1944177c95598ebd1986582dc8069a(self):
        return re.search(
            self.REPORTS_3d1944177c95598ebd1986582dc8069a_PATTERN, self.path
        )
    ...
    def reports_get_view_details_for_a_given_view_group_and_view_response(self):
        ...
        response_content = json.dumps(
            {
                "deliveries": [{"type": "string", "default": True}],
                "description": "string",
                "fieldGroups": [
                    {
                        "fieldGroupDisplayName": "string",
                ...
                "formats": [
                    {
                        ...
                        "name": "string",
                        "default": True,
                        "template": {"jsTemplateId": "string"},
                    }
                ],
                "schedules": [{"type": "string", "default": True}],
                "viewId": "string",
                "viewInfo": "string",
                "viewName": "string",
            }
    ...
    def matches_SDA_e414dcbeeabd5a359352a0e2ad5ec3f5(self):
        return re.search(self.SDA_e414dcbeeabd5a359352a0e2ad5ec3f5_PATTERN, self.path)
    ...
    def matches_SDA_d1d42ef2f1895a82a2830bf1353e6baa(self):
        return re.search(self.SDA_d1d42ef2f1895a82a2830bf1353e6baa_PATTERN, self.path)
    ...
    def matches_SDA_0d999a1d36ee52babb6b619877dad734(self):
        return re.search(self.SDA_0d999a1d36ee52babb6b619877dad734_PATTERN, self.path)
    ...
    def matches_SDA_916231b2be8b5dda8b81620b903afe9f(self):
        return re.search(self.SDA_916231b2be8b5dda8b81620b903afe9f_PATTERN, self.path)
    ...
    def matches_SDA_b6f2d8e46cdd5f05bb06f52cd1b26fb2(self):
        return re.search(self.SDA_b6f2d8e46cdd5f05bb06f52cd1b26fb2_PATTERN, self.path)
    ...
    def matches_SDA_7aae881ff75d5488a5325ea949be4c5b(self):
        return re.search(self.SDA_7aae881ff75d5488a5325ea949be4c5b_PATTERN, self.path)
    ...
    def matches_SDA_9a102ba155e35f84b7af3396aa407d02(self):
        return re.search(self.SDA_9a102ba155e35f84b7af3396aa407d02_PATTERN, self.path)
    ...
    def matches_SDA_6c05702ed7075a2f9ab14c051f1ac883(self):
        return re.search(self.SDA_6c05702ed7075a2f9ab14c051f1ac883_PATTERN, self.path)
    ...
    def matches_SDA_c1a89e4a8ff15608bc6c10d7ef7389d7(self):
        return re.search(self.SDA_c1a89e4a8ff15608bc6c10d7ef7389d7_PATTERN, self.path)
    ...
    def matches_SDA_54ae7f02a3d051f2baf7cc087990d658(self):
        return re.search(self.SDA_54ae7f02a3d051f2baf7cc087990d658_PATTERN, self.path)
    ...
    def matches_SDA_d12790f461c553a08142ec740db5efbf(self):
        return re.search(self.SDA_d12790f461c553a08142ec740db5efbf_PATTERN, self.path)
    ...
    def matches_SDA_1ea24b22ce355a229b7fd067401ddf3a(self):
        return re.search(self.SDA_1ea24b22ce355a229b7fd067401ddf3a_PATTERN, self.path)
    ...
    def matches_SDA_e0c7b28d55c85d49a84c1403ca14bd5f(self):
        return re.search(self.SDA_e0c7b28d55c85d49a84c1403ca14bd5f_PATTERN, self.path)
    ...
    def matches_SDA_409b70d8c6f85254a053ab281fd9e8fc(self):
        return re.search(self.SDA_409b70d8c6f85254a053ab281fd9e8fc_PATTERN, self.path)
    ...
    def matches_SDA_5a2ee396d6595001acfbbcdfa25093ff(self):
        return re.search(self.SDA_5a2ee396d6595001acfbbcdfa25093ff_PATTERN, self.path)
    ...
    def matches_SDA_0d23f3e54f8c59caac3ca905f7bf543a(self):
        return re.search(self.SDA_0d23f3e54f8c59caac3ca905f7bf543a_PATTERN, self.path)
    ...
    def matches_SDA_9124f9db3b115f0b8c8b3ce14bc5f975(self):
        return re.search(self.SDA_9124f9db3b115f0b8c8b3ce14bc5f975_PATTERN, self.path)
    ...
    def matches_SDA_9a764c85d8df5c30b9143619d4f9cde9(self):
        return re.search(self.SDA_9a764c85d8df5c30b9143619d4f9cde9_PATTERN, self.path)
    ...
    def matches_SDA_e4a09bf566f35babad9e27f5eb61a86d(self):
        return re.search(self.SDA_e4a09bf566f35babad9e27f5eb61a86d_PATTERN, self.path)
    ...
    def matches_SDA_27bd26b08b64545bae20f60c56891576(self):
        return re.search(self.SDA_27bd26b08b64545bae20f60c56891576_PATTERN, self.path)
    ...
    def matches_SDA_b035b0b3b60b5f2bb7c8c82e7f94b63b(self):
        return re.search(self.SDA_b035b0b3b60b5f2bb7c8c82e7f94b63b_PATTERN, self.path)
    ...
    def matches_SDA_072cb88b50dd5ead96ecfb4ab0390f47(self):
        return re.search(self.SDA_072cb88b50dd5ead96ecfb4ab0390f47_PATTERN, self.path)
    ...
    def matches_SDA_3af29516f0c8591da2a92523b5ab3386(self):
        return re.search(self.SDA_3af29516f0c8591da2a92523b5ab3386_PATTERN, self.path)
    ...
    def matches_SDA_a446d7327733580e9a6b661715eb4c09(self):
        return re.search(self.SDA_a446d7327733580e9a6b661715eb4c09_PATTERN, self.path)
    ...
    def matches_SDA_b7079a38844e56dd8f1b6b876880a02e(self):
        return re.search(self.SDA_b7079a38844e56dd8f1b6b876880a02e_PATTERN, self.path)
    ...
    def matches_SDA_55c27bbb42365955bc210924e1362c34(self):
        return re.search(self.SDA_55c27bbb42365955bc210924e1362c34_PATTERN, self.path)
                ...
                "multicastVnInfo": [
                    {
                        ...
                        "ssmInfo": [
                            {"ssmGroupRange": "string", "ssmWildcardMask": "string"}
                        ],
                    }
                ],
                "status": "string",
    ...
    def matches_SDA_45e8e007d3e25f7fb83a6579016aea72(self):
        return re.search(self.SDA_45e8e007d3e25f7fb83a6579016aea72_PATTERN, self.path)
    ...
    def matches_SDA_e5bd8dbbf65253f0aadd77a62b1b8b58(self):
        return re.search(self.SDA_e5bd8dbbf65253f0aadd77a62b1b8b58_PATTERN, self.path)
    ...
    def matches_SDA_fd488ff002115f3b8f0ee165e5347609(self):
        return re.search(self.SDA_fd488ff002115f3b8f0ee165e5347609_PATTERN, self.path)
    ...
    def matches_SDA_7750d1608b2751c883a072ee3fb80228(self):
        return re.search(self.SDA_7750d1608b2751c883a072ee3fb80228_PATTERN, self.path)
    ...
    def matches_SDA_d8f10868c21856eab31776f109aba2bb(self):
        return re.search(self.SDA_d8f10868c21856eab31776f109aba2bb_PATTERN, self.path)
    ...
    def matches_SDA_770a34aab91750028f4d584d36811844(self):
        return re.search(self.SDA_770a34aab91750028f4d584d36811844_PATTERN, self.path)
    ...
    def matches_SDA_6d39e10793a45d3db229d6d3820c665a(self):
        return re.search(self.SDA_6d39e10793a45d3db229d6d3820c665a_PATTERN, self.path)
    ...
    def matches_SDA_096d7073129453698264e7519d82991c(self):
        return re.search(self.SDA_096d7073129453698264e7519d82991c_PATTERN, self.path)
    ...
    def matches_SDA_176cb9f8ad5359b2b2cbc151ac3a842a(self):
        return re.search(self.SDA_176cb9f8ad5359b2b2cbc151ac3a842a_PATTERN, self.path)
    ...
    def matches_SDA_cb1fe08692b85767a42b84340c4c7d53(self):
        return re.search(self.SDA_cb1fe08692b85767a42b84340c4c7d53_PATTERN, self.path)
    ...
    def matches_SDA_15e3a724a35854758d65a83823c88435(self):
        return re.search(self.SDA_15e3a724a35854758d65a83823c88435_PATTERN, self.path)
    ...
    def matches_SDA_ccf5ce99e049525f8184fcaa5991d919(self):
        return re.search(self.SDA_ccf5ce99e049525f8184fcaa5991d919_PATTERN, self.path)
        ...
        response_content = json.dumps(
            {
                ...
                "virtualNetworkSummary": [
                    {"siteNameHierarchy": "string", "virtualNetworkName": "string"}
                ],
                "status": "string",
                "description": "string",
            }
    ...
    def matches_SDA_b88723912610599ba42292db52d1dae4(self):
        return re.search(self.SDA_b88723912610599ba42292db52d1dae4_PATTERN, self.path)
    ...
    def matches_SDA_951c923d016d5401b7a9943724df3844(self):
        return re.search(self.SDA_951c923d016d5401b7a9943724df3844_PATTERN, self.path)
    ...
    def matches_SDA_62b07f187b7456c8bbb6088a2f24dcee(self):
        return re.search(self.SDA_62b07f187b7456c8bbb6088a2f24dcee_PATTERN, self.path)
    ...
    def matches_SDA_72472f5ebb9d50aab287f320d32181c0(self):
        return re.search(self.SDA_72472f5ebb9d50aab287f320d32181c0_PATTERN, self.path)
    ...
    def matches_SDA_2f2e8552eabc5e5f97e1f40bcc4b4c75(self):
        return re.search(self.SDA_2f2e8552eabc5e5f97e1f40bcc4b4c75_PATTERN, self.path)
    ...
    def matches_SDA_ea4b1c052b855bd9a0e99f803e6185a5(self):
        return re.search(self.SDA_ea4b1c052b855bd9a0e99f803e6185a5_PATTERN, self.path)
    ...
    def matches_SDA_f9492367570c5f009cf8b5955790e87c(self):
        return re.search(self.SDA_f9492367570c5f009cf8b5955790e87c_PATTERN, self.path)
    ...
    def matches_SECURITY_ADVISORIES_4e6317a46c835f0881f08071959bb026(self):
        return re.search(
            self.SECURITY_ADVISORIES_4e6317a46c835f0881f08071959bb026_PATTERN, self.path
        )
    ...
    def matches_SECURITY_ADVISORIES_8947b24a5127510a8070b0f893494543(self):
        return re.search(
            self.SECURITY_ADVISORIES_8947b24a5127510a8070b0f893494543_PATTERN, self.path
        )
    ...
    def security_advisories_get_advisories_summary_response(self):
        ...
        response_content = json.dumps(
            {
                "response": {
                    "NA": {"CONFIG": 0, "VERSION": 0, "TOTAL": 0},
                    "INFORMATIONAL": {"CONFIG": 0, "VERSION": 0, "TOTAL": 0},
                    "LOW": {"CONFIG": 0, "VERSION": 0, "TOTAL": 0},
                    "MEDIUM": {"CONFIG": 0, "VERSION": 0, "TOTAL": 0},
                    "HIGH": {"CONFIG": 0, "VERSION": 0, "TOTAL": 0},
                    "CRITICAL": {"CONFIG": 0, "VERSION": 0, "TOTAL": 0},
                },
                "version": "string",
            }
        )
    ...
    def matches_SECURITY_ADVISORIES_cbdf8887b29b5f0ea87113d2ae17d6df(self):
        return re.search(
            self.SECURITY_ADVISORIES_cbdf8887b29b5f0ea87113d2ae17d6df_PATTERN, self.path
        )
    ...
    def matches_SECURITY_ADVISORIES_34b1c03688485b44b1547c428a887c5d(self):
        return re.search(
            self.SECURITY_ADVISORIES_34b1c03688485b44b1547c428a887c5d_PATTERN, self.path
        )
    ...
    def security_advisories_get_advisory_ids_per_device_response(self):
        ...
        response_content = json.dumps(
            {
                "response": [{"deviceId": "string", "advisoryIds": ["string"]}],
                "version": "string",
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
    ...
    def matches_SECURITY_ADVISORIES_7cf75923b0c6575ead874f9d404d7355(self):
        return re.search(
            self.SECURITY_ADVISORIES_7cf75923b0c6575ead874f9d404d7355_PATTERN, self.path
        )
    ...
    def matches_SENSORS_e2f9718de3d050819cdc6355a3a43200(self):
        return re.search(
            self.SENSORS_e2f9718de3d050819cdc6355a3a43200_PATTERN, self.path
        )
    ...
    def matches_SENSORS_6f7dd6a6cf8d57499168aae05847ad34(self):
        return re.search(
            self.SENSORS_6f7dd6a6cf8d57499168aae05847ad34_PATTERN, self.path
        )
    ...
    def matches_SENSORS_a1c0ac4386555300b7f4a541d8dba625(self):
        return re.search(
            self.SENSORS_a1c0ac4386555300b7f4a541d8dba625_PATTERN, self.path
        )
    ...
    def sensors_delete_sensor_test_response(self):
        ...
        response_content = json.dumps(
            {
                "version": "string",
                "response": {"templateName": "string", "status": "string"},
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
        return
    ...
    def matches_SENSORS_49925cda740c5bdc92fd150c334d0e4e(self):
        return re.search(
            self.SENSORS_49925cda740c5bdc92fd150c334d0e4e_PATTERN, self.path
        )
    ...
    def matches_SENSORS_cfadc5e4c912588389f4f63d2fb6e4ed(self):
        return re.search(
            self.SENSORS_cfadc5e4c912588389f4f63d2fb6e4ed_PATTERN, self.path
        )
    ...
    def matches_SENSORS_a352f6280e445075b3ea7cbf868c2d94(self):
        return re.search(
            self.SENSORS_a352f6280e445075b3ea7cbf868c2d94_PATTERN, self.path
        )
    ...
    def matches_SITE_DESIGN_cc72e307e5df50c48ce57370f27395a0(self):
        return re.search(
            self.SITE_DESIGN_cc72e307e5df50c48ce57370f27395a0_PATTERN, self.path
        )
    ...
    def matches_SITE_DESIGN_2bfde206eb445821a5722511f138814a(self):
        return re.search(
            self.SITE_DESIGN_2bfde206eb445821a5722511f138814a_PATTERN, self.path
        )
    ...
    def matches_SITE_DESIGN_378a1800508058e4b82a08ea5637b794(self):
        return re.search(
            self.SITE_DESIGN_378a1800508058e4b82a08ea5637b794_PATTERN, self.path
        )
    ...
    def matches_SITE_DESIGN_21c8936d6a0c54e89b471fe36bf28de8(self):
        return re.search(
            self.SITE_DESIGN_21c8936d6a0c54e89b471fe36bf28de8_PATTERN, self.path
        )
    ...
    def matches_SITE_DESIGN_497d9ccfce8451809129ec5de42c5048(self):
        return re.search(
            self.SITE_DESIGN_497d9ccfce8451809129ec5de42c5048_PATTERN, self.path
        )
    ...
    def matches_SITE_DESIGN_d2a712eb315650618d475db5de0aabec(self):
        return re.search(
            self.SITE_DESIGN_d2a712eb315650618d475db5de0aabec_PATTERN, self.path
        )
    ...
    def matches_SITE_DESIGN_159612e2202e5f7586e68778ed7772b1(self):
        return re.search(
            self.SITE_DESIGN_159612e2202e5f7586e68778ed7772b1_PATTERN, self.path
        )
    ...
    def matches_SITE_DESIGN_f50579d855255df89ab3545de9745545(self):
        return re.search(
            self.SITE_DESIGN_f50579d855255df89ab3545de9745545_PATTERN, self.path
        )
    ...
    def matches_SITE_DESIGN_89252bcefb205d26b9aced6dc6d8c269(self):
        return re.search(
            self.SITE_DESIGN_89252bcefb205d26b9aced6dc6d8c269_PATTERN, self.path
        )
    ...
    def matches_SITES_0a544e27e18e5412af3b68d915c8ca50(self):
        return re.search(self.SITES_0a544e27e18e5412af3b68d915c8ca50_PATTERN, self.path)
    ...
    def matches_SITES_63284ca11e0b5f8d91395e2462a9cfdc(self):
        return re.search(self.SITES_63284ca11e0b5f8d91395e2462a9cfdc_PATTERN, self.path)
    ...
    def sites_get_membership_response(self):
        ...
        response_content = json.dumps(
            {
                "site": {"response": [{}], "version": "string"},
                "device": [{"response": [{}], "version": "string", "siteId": "string"}],
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
        return
    ...
    def matches_SITES_bce8e6b307ce52dd8f5546fbd78e05ee(self):
        return re.search(self.SITES_bce8e6b307ce52dd8f5546fbd78e05ee_PATTERN, self.path)
    ...
    def matches_SITES_dbdd6074bedc59b9a3edd6477897d659(self):
        return re.search(self.SITES_dbdd6074bedc59b9a3edd6477897d659_PATTERN, self.path)
    ...
    def matches_SITES_ae4b592f66035f24b55028f79c1b7290(self):
        return re.search(self.SITES_ae4b592f66035f24b55028f79c1b7290_PATTERN, self.path)
                ...
                "response": [
                    {
                        ...
                        "applicationHealthStats": {
                            ...
                            "defaultHealthAppCount": {"poor": 0, "fair": 0, "good": 0},
                        },
                    }
                ]
            }
    ...
    def matches_SITES_e7a025fbe2c452fc82eedd5c50104aba(self):
        return re.search(self.SITES_e7a025fbe2c452fc82eedd5c50104aba_PATTERN, self.path)
    ...
    def matches_SITES_27df9908ad265e83ab77d73803925678(self):
        return re.search(self.SITES_27df9908ad265e83ab77d73803925678_PATTERN, self.path)
    ...
    def matches_SITES_ba5567f03dea5b6891957dd410319e3f(self):
        return re.search(self.SITES_ba5567f03dea5b6891957dd410319e3f_PATTERN, self.path)
    ...
    def software_image_management_swim_trigger_software_image_distribution_response(
        self,
    ):
        # Add response status code.
        self.send_response(requests.codes.ok)
        ...
        response_content = json.dumps(
            {
                "version": "string",
                "response": [
                    {"deviceFamily": "string", "deviceFamilyIdentifier": "string"}
                ],
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
    ...
    def software_image_management_swim_tag_as_golden_image_response(self):
        ...
        # Add response content.
        response_content = json.dumps(
            {"version": "string", "response": {"url": "string", "taskId": "string"}}
        )
        self.wfile.write(response_content.encode("utf-8"))
        return
    ...
    def matches_SYSTEM_SETTINGS_f7cc2592721f5b9b9f99795a26130147(self):
        return re.search(
            self.SYSTEM_SETTINGS_f7cc2592721f5b9b9f99795a26130147_PATTERN, self.path
        )
    ...
    def matches_SYSTEM_SETTINGS_ada20dc4915d5901b50634628392e79f(self):
        return re.search(
            self.SYSTEM_SETTINGS_ada20dc4915d5901b50634628392e79f_PATTERN, self.path
        )
    ...
    def matches_SYSTEM_SETTINGS_d2ea814bfae85da1b77872d095fc8221(self):
        return re.search(
            self.SYSTEM_SETTINGS_d2ea814bfae85da1b77872d095fc8221_PATTERN, self.path
        )
    ...
    def matches_TAG_c9f995abc21b54e7860f66aef2ffbc85(self):
        return re.search(self.TAG_c9f995abc21b54e7860f66aef2ffbc85_PATTERN, self.path)
    ...
    def matches_TAG_983979a4185f5b40aabe991f8cdb2816(self):
        return re.search(self.TAG_983979a4185f5b40aabe991f8cdb2816_PATTERN, self.path)
    ...
    def matches_TAG_e8271b05b62c54609f74b4f2f373ad5a(self):
        return re.search(self.TAG_e8271b05b62c54609f74b4f2f373ad5a_PATTERN, self.path)
    ...
    def matches_TAG_afb52259f7c3501ca4d8ccd277828658(self):
        return re.search(self.TAG_afb52259f7c3501ca4d8ccd277828658_PATTERN, self.path)
    ...
    def matches_TAG_e3934b0fb68a5ff787e65e9b7c8e6296(self):
        return re.search(self.TAG_e3934b0fb68a5ff787e65e9b7c8e6296_PATTERN, self.path)
    ...
    def matches_TAG_9baf47897d525e5899f62e4d5bdd260b(self):
        return re.search(self.TAG_9baf47897d525e5899f62e4d5bdd260b_PATTERN, self.path)
    ...
    def matches_TAG_153ed48fc373506cb1688cff36c2cb0f(self):
        return re.search(self.TAG_153ed48fc373506cb1688cff36c2cb0f_PATTERN, self.path)
    ...
    def matches_TAG_4d65f9b9d8ad5426bdf7e55461fcf761(self):
        return re.search(self.TAG_4d65f9b9d8ad5426bdf7e55461fcf761_PATTERN, self.path)
    ...
    def matches_TAG_ff12c50ea3fb53c9a53f9c9e2c595d44(self):
        return re.search(self.TAG_ff12c50ea3fb53c9a53f9c9e2c595d44_PATTERN, self.path)
    ...
    def tag_get_tag_members_by_id_response(self):
        ...
        # Add response content.
        response_content = json.dumps(
            {"version": "string", "response": [{"instanceUuid": "string"}]}
        )
        self.wfile.write(response_content.encode("utf-8"))
        return

    def matches_TAG_dcc43be0514e50fea80cfa827f13ee5c(self):
        return re.search(self.TAG_dcc43be0514e50fea80cfa827f13ee5c_PATTERN, self.path)
    ...
    def matches_TAG_82ffacb52f745c15b40b9b352754e2e1(self):
        return re.search(self.TAG_82ffacb52f745c15b40b9b352754e2e1_PATTERN, self.path)
    ...
    def matches_TAG_5581cc9883be5c1cad1959347babb342(self):
        return re.search(self.TAG_5581cc9883be5c1cad1959347babb342_PATTERN, self.path)
    ...
    def matches_TASK_0ffc19ddea705526b7d9db01baf4997e(self):
        return re.search(self.TASK_0ffc19ddea705526b7d9db01baf4997e_PATTERN, self.path)
    ...
    def matches_TASK_75ff485556f6504d8443789f42098be7(self):
        return re.search(self.TASK_75ff485556f6504d8443789f42098be7_PATTERN, self.path)
    ...
    def matches_TASK_8d0586946be75e0f9f2c170217d45a28(self):
        return re.search(self.TASK_8d0586946be75e0f9f2c170217d45a28_PATTERN, self.path)
    ...
    def matches_TASK_d95c21e41dce5a9dbee07d33eefef2b2(self):
        return re.search(self.TASK_d95c21e41dce5a9dbee07d33eefef2b2_PATTERN, self.path)
    ...
    def matches_TASK_8009857899a75ba5a6bae1d568700bd3(self):
        return re.search(self.TASK_8009857899a75ba5a6bae1d568700bd3_PATTERN, self.path)
    ...
    def matches_TASK_8fa2865e229b536aacd59585a1d29704(self):
        return re.search(self.TASK_8fa2865e229b536aacd59585a1d29704_PATTERN, self.path)
    ...
    def matches_TOPOLOGY_4b0753b63045528194f2f5bbf8ae432d(self):
        return re.search(
            self.TOPOLOGY_4b0753b63045528194f2f5bbf8ae432d_PATTERN, self.path
        )
    ...
    def matches_TOPOLOGY_392b3f79d3b45b98849d9180cc08018e(self):
        return re.search(
            self.TOPOLOGY_392b3f79d3b45b98849d9180cc08018e_PATTERN, self.path
        )
    ...
    def matches_TOPOLOGY_c7e9c39880735e7684291bc5dc3ba994(self):
        return re.search(
            self.TOPOLOGY_c7e9c39880735e7684291bc5dc3ba994_PATTERN, self.path
        )
    ...
    def matches_TOPOLOGY_4199688eb4ab5a978fe8785516c8af42(self):
        return re.search(
            self.TOPOLOGY_4199688eb4ab5a978fe8785516c8af42_PATTERN, self.path
        )
    ...
    def matches_TOPOLOGY_f7abdb7ab46a5918a74e839488ff6ae0(self):
        return re.search(
            self.TOPOLOGY_f7abdb7ab46a5918a74e839488ff6ae0_PATTERN, self.path
        )
    ...
    def matches_TOPOLOGY_fb6000ce8d8854bc80be3803b8dee1b7(self):
        return re.search(
            self.TOPOLOGY_fb6000ce8d8854bc80be3803b8dee1b7_PATTERN, self.path
        )
    ...
    def matches_USERAND_ROLES_9ec0b30eca9d540a845848cffd7c602a(self):
        return re.search(
            self.USERAND_ROLES_9ec0b30eca9d540a845848cffd7c602a_PATTERN, self.path
        )
    ...
    def matches_USERAND_ROLES_bef02e8f6f8354dc99e375826a87c88c(self):
        return re.search(
            self.USERAND_ROLES_bef02e8f6f8354dc99e375826a87c88c_PATTERN, self.path
        )
    ...
    def matches_USERAND_ROLES_7fa405b6d1be56739f2dfeea63212015(self):
        return re.search(
            self.USERAND_ROLES_7fa405b6d1be56739f2dfeea63212015_PATTERN, self.path
        )
    ...
    def matches_USERAND_ROLES_6d82755e5e03510daf0951c1f42c2702(self):
        return re.search(
            self.USERAND_ROLES_6d82755e5e03510daf0951c1f42c2702_PATTERN, self.path
        )
    ...
    def matches_USERAND_ROLES_34d2bd5f05bd535a89ebadb30e2ede9e(self):
        return re.search(
            self.USERAND_ROLES_34d2bd5f05bd535a89ebadb30e2ede9e_PATTERN, self.path
        )
    ...
    def matches_USERAND_ROLES_452738def9045d4d9c96bcd42172a79c(self):
        return re.search(
            self.USERAND_ROLES_452738def9045d4d9c96bcd42172a79c_PATTERN, self.path
        )
    ...
    def matches_USERS_70f9c1d861a051b4a4928f2e6d84b2e3(self):
        return re.search(self.USERS_70f9c1d861a051b4a4928f2e6d84b2e3_PATTERN, self.path)
    ...
    def matches_WIRELESS_dde2b077d6d052dcae5a76f4aac09c1d(self):
        return re.search(
            self.WIRELESS_dde2b077d6d052dcae5a76f4aac09c1d_PATTERN, self.path
        )
        ...
        response_content = json.dumps(
            {
                "summary": {
                    "totalTestCount": 0,
                    "ONBOARDING": {
                        "AUTH": {"passCount": 0, "failCount": 0},
                        "DHCP": {"passCount": 0, "failCount": 0},
                        "ASSOC": {"passCount": 0, "failCount": 0},
                    },
                    "PERFORMANCE": {"IPSLASENDER": {"passCount": 0, "failCount": 0}},
                    "NETWORK_SERVICES": {"DNS": {"passCount": 0, "failCount": 0}},
                    "APP_CONNECTIVITY": {
                        "HOST_REACHABILITY": {"passCount": 0, "failCount": 0},
                        "WEBSERVER": {"passCount": 0, "failCount": 0},
                        "FILETRANSFER": {"passCount": 0, "failCount": 0},
                    },
                    "RF_ASSESSMENT": {
                        "DATA_RATE": {"passCount": 0, "failCount": 0},
                        "SNR": {"passCount": 0, "failCount": 0},
                    },
                    "EMAIL": {"MAILSERVER": {"passCount": 0, "failCount": 0}},
                },
                "failureStats": [
                    {
                        "errorCode": 0,
    ...
    def matches_WIRELESS_d825ae9a117f5b6bb65b7d78fd42513c(self):
        return re.search(
            self.WIRELESS_d825ae9a117f5b6bb65b7d78fd42513c_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_8e56eb2c294159d891b7dbe493ddc434(self):
        return re.search(
            self.WIRELESS_8e56eb2c294159d891b7dbe493ddc434_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_858f5602b2965e53b5bdda193025a3fc(self):
        return re.search(
            self.WIRELESS_858f5602b2965e53b5bdda193025a3fc_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_1ebabf7f1ce2537f8aedd93e5f5aab1b(self):
        return re.search(
            self.WIRELESS_1ebabf7f1ce2537f8aedd93e5f5aab1b_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_fb757e8fce4b51ffa0ba1a8e5ae4d8c0(self):
        return re.search(
            self.WIRELESS_fb757e8fce4b51ffa0ba1a8e5ae4d8c0_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_bc33daf690ec5399a507829abfc4fe64(self):
        return re.search(
            self.WIRELESS_bc33daf690ec5399a507829abfc4fe64_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_25479623a94058a99acaaf8eb73c9227(self):
        return re.search(
            self.WIRELESS_25479623a94058a99acaaf8eb73c9227_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_6a43afa4d91a5043996c682a7a7a2d62(self):
        return re.search(
            self.WIRELESS_6a43afa4d91a5043996c682a7a7a2d62_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_9610a850fb6c5451a7ad20ba76f4ff43(self):
        return re.search(
            self.WIRELESS_9610a850fb6c5451a7ad20ba76f4ff43_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_6e0bd567c1395531a7f18ab4e14110bd(self):
        return re.search(
            self.WIRELESS_6e0bd567c1395531a7f18ab4e14110bd_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_435cc2c3a5b75a4091350fa84ac872c9(self):
        return re.search(
            self.WIRELESS_435cc2c3a5b75a4091350fa84ac872c9_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_0fb7514b0e8c52be8cfd19dab5e31b06(self):
        return re.search(
            self.WIRELESS_0fb7514b0e8c52be8cfd19dab5e31b06_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_09f790a930d452708353c374f5c0f90f(self):
        return re.search(
            self.WIRELESS_09f790a930d452708353c374f5c0f90f_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_36c00df3623b5a74ad41e75487ed9b77(self):
        return re.search(
            self.WIRELESS_36c00df3623b5a74ad41e75487ed9b77_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_2583c9fb8b0f5c69ba22f920e4044538(self):
        return re.search(
            self.WIRELESS_2583c9fb8b0f5c69ba22f920e4044538_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_82bfd78707835bc8934cf0df1b0169fc(self):
        return re.search(
            self.WIRELESS_82bfd78707835bc8934cf0df1b0169fc_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_5135bbf7ce025bc2a291b90c37a6b898(self):
        return re.search(
            self.WIRELESS_5135bbf7ce025bc2a291b90c37a6b898_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_b95201b6a6905a10b463e036bf591166(self):
        return re.search(
            self.WIRELESS_b95201b6a6905a10b463e036bf591166_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_bbc1866a50505c0695ae243718d51936(self):
        return re.search(
            self.WIRELESS_bbc1866a50505c0695ae243718d51936_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_d0aab00569b258b481afedc35e6db392(self):
        return re.search(
            self.WIRELESS_d0aab00569b258b481afedc35e6db392_PATTERN, self.path
        )
        ...
        response_content = json.dumps(
            {
                "executionId": "string",
                "executionUrl": "string",
                "provisioningTasks": {"success": ["string"], "failed": ["string"]},
            }
        )
        self.wfile.write(response_content.encode("utf-8"))
        return
    ...
    def matches_WIRELESS_359718e31c795964b3bdf85da1b5a2a5(self):
        return re.search(
            self.WIRELESS_359718e31c795964b3bdf85da1b5a2a5_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_f99c96c3a9b45ddaabc2c75ff8efa67f(self):
        return re.search(
            self.WIRELESS_f99c96c3a9b45ddaabc2c75ff8efa67f_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_ac37d6798c0b593088952123df03bb1b(self):
        return re.search(
            self.WIRELESS_ac37d6798c0b593088952123df03bb1b_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_5f24f6c07641580ba6ed710e92c2da16(self):
        return re.search(
            self.WIRELESS_5f24f6c07641580ba6ed710e92c2da16_PATTERN, self.path
        )
    ...
    def matches_WIRELESS_97f3790386da5cd49480cb0503e59047(self):
        return re.search(
            self.WIRELESS_97f3790386da5cd49480cb0503e59047_PATTERN, self.path
        )
    ...
    def do_GET(self):
        ...
        if self.matches_EVENT_MANAGEMENT_6e698d5a990a55158003a9f3250316a8():
        ...
        if self.matches_LICENSES_87c0cf04bdc758b29bb11abbdacbd921():
            self.licenses_device_count_details2_response()
            return

        if self.matches_LICENSES_f4ba64eef4085d518a612835e128fe3c():
            self.licenses_device_license_summary2_response()
            return

        if self.matches_LICENSES_6f04f865c01d5c17a5f0cb5abe620dd8():
            self.licenses_device_license_details2_response()
            return

        if self.matches_LICENSES_8ab450b197375fa9bcd95219113a3075():
            self.licenses_virtual_account_details2_response()
            return
        ...
        if self.matches_LICENSES_df2d278e89b45c8ea0ca0a945c001f08():
            self.licenses_license_term_details2_response()
            return

        if self.matches_LICENSES_46e55ecbbda454c6a01d905e6f4cce16():
            self.licenses_license_usage_details2_response()
            return
        ...
        if (
            self.matches_SOFTWARE_IMAGE_MANAGEMENT_SWIM_039f73101d5d5e409f571084ab4c6049()
        ):
            self.software_image_management_swim_get_software_image_details_response()
            return

        if (
            self.matches_SOFTWARE_IMAGE_MANAGEMENT_SWIM_b5c47f316ff058eb979bdea047f9d5b5()
        ):
            self.software_image_management_swim_get_device_family_identifiers_response()
            return

        if (
            self.matches_SOFTWARE_IMAGE_MANAGEMENT_SWIM_97ab6266cac654d394cf943a161fcc7b()
        ):
    ...
    def do_POST(self):
        ...
        if self.matches_CISCO_DNA_CENTER_SYSTEM_5627d9227adc5f02b7cd264af7255d19():
            self.cisco_dna_center_system_authorize_device_response()
            return
        ...
        if self.matches_LICENSES_4bd5b507f58a50aab614e3d7409eec4c():
            self.licenses_change_virtual_account2_response()
            return
        ...
        if (
            self.matches_SOFTWARE_IMAGE_MANAGEMENT_SWIM_22891a9136d5513985f15e91a19da66c()
        ):
            self.software_image_management_swim_trigger_software_image_activation_response()
            return

        if (
            self.matches_SOFTWARE_IMAGE_MANAGEMENT_SWIM_6c8d11fb9fc752ab8bb8e2b1413ccc92()
        ):
            self.software_image_management_swim_trigger_software_image_distribution_response()
            return

        if (
            self.matches_SOFTWARE_IMAGE_MANAGEMENT_SWIM_a9b864257b965fe4bd8b0293f41f1537()
        ):
            self.software_image_management_swim_tag_as_golden_image_response()
            return

        if (
            self.matches_SOFTWARE_IMAGE_MANAGEMENT_SWIM_2399c1cf6d5d5f0fa2e92539134b6c1d()
        ):
            self.software_image_management_swim_import_local_software_image_response()
            return

        if (
            self.matches_SOFTWARE_IMAGE_MANAGEMENT_SWIM_7be8cdb967555fcca03a4c1f796eee56()
        ):
    ...
    def do_PUT(self):
        ...
        if self.matches_LICENSES_0109b2f15d0c54c2862a60a904289ddd():
            self.licenses_device_deregistration2_response()
            return
    ...
    def do_DELETE(self):
        ...
        if (
            self.matches_SOFTWARE_IMAGE_MANAGEMENT_SWIM_2405e9dd960c5378ab442f235c8135d0()
        ):
