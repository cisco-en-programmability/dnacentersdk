...
class MockServerRequestHandler_v2_3_3_0(BaseHTTPRequestHandler):
    ...
    def fabric_wireless_update_ssid_to_ip_pool_mapping2_response(self):
        # Add response status code.
        self.send_response(requests.codes.ok)
        # Add response headers.
        self.send_header('Content-Type', 'application/json; charset=utf-8')
    ...
    def sda_get_multicast_details_from_sda_fabric_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'siteNameHierarchy': 'string', 'multicastMethod': 'string', 'multicastType': 'string', 'multicastVnInfo': [{'virtualNetworkName': 'string', 'ipPoolName': 'string', 'internalRpIpAddress': ['string'], 'externalRpIpAddress': 'string', 'ssmInfo': {'ssmGroupRange': 'string', 'ssmWildcardMask': 'string'}}]})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def sda_get_transit_peer_network_info_response(self):
        ...
        self.end_headers()
        # Add response content.
        response_content = json.dumps({'transitPeerNetworkName': 'string', 'transitPeerNetworkType': 'string', 'ipTransitSettings': {'routingProtocolName': 'string', 'autonomousSystemNumber': 'string'}, 'sdaTransitSettings': {'transitControlPlaneSettings': [{'siteNameHierarchy': 'string', 'deviceManagementIpAddress': 'string'}]}})
        self.wfile.write(response_content.encode('utf-8'))
        return
    ...
    def do_PUT(self):
        ...
        if self.matches_FABRIC_WIRELESS_249809f90ae8599c8a21c98b7a1ca804():
            self.fabric_wireless_update_ssid_to_ip_pool_mapping2_response()
            return
