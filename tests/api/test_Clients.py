...
def test_get_overall_client_health(api):
    endpoint_result = api.clients.get_overall_client_health( param_timestamp = '1560378327')
...
def test_get_client_detail(api):
    endpoint_result = api.clients.get_client_detail( param_mac_address = '1c:36:bb:25:3e:12', param_timestamp = '1560378327')
