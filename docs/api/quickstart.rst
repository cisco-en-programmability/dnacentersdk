...
By default, dnacentersdk will look for the following environment variables to create new connection objects:
    ...
    * ``DNA_CENTER_VERSION`` - DNA Center API version to use. Defaults to '2.3.2.0'.
...
.. code-block:: python
    ...
    VersionError: Unknown API version, known versions are 1.2.10, 1.3.0, 1.3.1, 1.3.3, 2.1.1, 2.1.2, 2.2.1, 2.2.2.3, 2.2.3.3 and 2.3.2.0.
...
.. code-block:: python
    ...
    >>> from dnacentersdk import DNACenterAPI
    >>> # Create a DNACenterAPI connection object; it uses DNA Center sandbox URL and encoded_auth, with DNA Center API version 2.3.2.0
    >>> api = DNACenterAPI(encoded_auth='ZGV2bmV0dXNlcjpDaXNjbzEyMyEK', base_url="https://sandboxdnac.cisco.com:443", version='2.3.2.0')

.. code-block:: python

    >>> from dnacentersdk import DNACenterAPI
    >>> # Create a DNACenterAPI connection object; it uses DNA Center username and password, with DNA Center API version 2.3.2.0
    >>> # The base_url used by default is `from dnacentersdk.config import DEFAULT_BASE_URL`
    >>> api = DNACenterAPI(username='devnetuser', password='Cisco123!', base_url="https://sandboxdnac.cisco.com:443", version='2.3.2.0')
...
.. code-block:: python
    ...
    >>> kingston_api = DNACenterAPI(encoded_auth=kingston_auth, base_url="https://sandboxdnac.cisco.com:443", version='2.3.2.0')
    >>> london_api = DNACenterAPI(*london_auth, base_url="https://128.107.71.199:443", version='2.3.2.0')  # * Unpacks tuple
...
.. code-block:: python
    ...
    ... base_url="https://128.107.71.199:443", version='2.3.2.0')
...
.. code-block:: python
    ...
    # Create a DNACenterAPI connection object;
    # it uses DNA Center sandbox URL, username and password, with DNA Center API version 2.3.2.0.,
