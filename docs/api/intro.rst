...
.. code-block:: python
    ...
    api_ = api.DNACenterAPI(base_url='https://sandboxdnac.cisco.com:443', version='2.3.7.5')
...
+ Reads your DNA Center API version from environment variable DNA_CENTER_VERSION. Supported versions: 2.1.1, 2.1.2, 2.2.1, 2.2.2.3, 2.2.3.3, 2.3.3.0, 2.3.5.3, 2.3.7.3 and 2.3.7.5. Now with version and base_url, you have more control.
...
.. code-block:: python
    ...
    # Create a DNACenterAPI connection object; it uses DNA Center sandbox URL, username and password, with DNA Center API version 2.3.7.5.
    api_ = api.DNACenterAPI(username="devnetuser", password="Cisco123!", base_url="https://sandboxdnac.cisco.com:443", version='2.3.7.5')
