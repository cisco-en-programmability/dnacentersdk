...
+ Reads your DNA Center API version from environment variable DNA_CENTER_VERSION. Supported versions: 2.2.2.3, 2.2.3.3, 2.3.3.0, 2.3.5.3 and 2.3.7.5. Now with version and base_url, you have more control.
