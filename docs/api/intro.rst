...
+ Reads your DNA Center API version from environment variable DNA_CENTER_VERSION. Supported versions: 1.2.10, 1.3.0, 1.3.1, 1.3.3, 2.1.1, 2.1.2, 2.2.1 and 2.2.2.3. Now with version and base_url, you have more control.
