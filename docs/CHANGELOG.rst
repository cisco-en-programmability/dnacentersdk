...
`Unreleased <https://github.com/cisco-en-programmability/dnacentersdk/compare/v2.11.4...develop>`__
---------------------------------------------------------------------------------------------------

`2.11.4 <https://github.com/cisco-en-programmability/dnacentersdk/compare/v2.11.3...v2.11.4>`__ - 2026-05-07
------------------------------------------------------------------------------------------------------------

Fixed
~~~~~

- **Authorization retries not applying to auth requests (PR #248)**: The
  ``Authentication`` class was issuing token requests via bare
  ``requests.post()`` calls, bypassing any ``urllib3.Retry`` adapter
  configured on the session. This meant user-configured retry logic —
  intended to handle intermittent network issues — was silently ignored
  during authentication. ``Authentication`` now accepts an optional
  ``requests.Session`` and uses it for token requests, so retry adapters
  apply uniformly across all SDK calls.

.. _section-1:

`2.11.3 <https://github.com/cisco-en-programmability/dnacentersdk/compare/v2.11.2...v2.11.3>`__ - 2026-05-05
------------------------------------------------------------------------------------------------------------
